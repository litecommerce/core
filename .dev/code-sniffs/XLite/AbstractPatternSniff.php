 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
abstract class XLite_AbstractPatternSniff extends XLite_ReqCodesSniff
{
    ...
    {
		$rc = isset($this->patReqCodes[$patternCode]) ? $this->patReqCodes[$patternCode] : '?';
        ...
        $error = $this->getReqPrefix($rc) . "Expected \"$expected\"; found \"$found\"";
