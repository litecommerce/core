<?php
/**
 * XLite_Sniffs_Functions_FunctionDeclarationSniff.
 *
 * PHP version 5
 *
 * @category  PHP
...
/**
 * XLite_Sniffs_PHP_Formatting_MultiLineAssignmentSniff.
 *
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class XLite_Sniffs_PHP_Formatting_MultiLineAssignmentSniff extends XLite_ReqCodesSniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$next]['line'] !== $tokens[$stackPtr]['line']) {
            ...
            $phpcsFile->addError($this->getReqPrefix('REQ.PHP.2.8.2') . $error, $stackPtr);
            return;
        }
        ...
        if ($foundIndent !== $expectedIndent) {
            ...
            $phpcsFile->addError($this->getReqPrefix('REQ.PHP.2.8.3') . $error, $stackPtr);
        }
