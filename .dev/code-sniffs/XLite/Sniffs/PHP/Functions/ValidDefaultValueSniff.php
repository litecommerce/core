<?php
/**
 * XLite_Sniffs_PHP_Functions_ValidDefaultValueSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class XLite_Sniffs_PHP_Functions_ValidDefaultValueSniff extends XLite_ReqCodesSniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        while (($nextArg = $phpcsFile->findNext(T_VARIABLE, ($nextArg + 1), $argEnd)) !== false) {
            ...
            if (($argHasDefault === false) && ($defaultFound === true)) {
                ...
                $phpcsFile->addError($this->getReqPrefix('REQ.PHP.3.5.13') . $error, $nextArg);
                return;
            }
