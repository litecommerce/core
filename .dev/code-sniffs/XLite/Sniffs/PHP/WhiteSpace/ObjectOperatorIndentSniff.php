<?php
/**
 * XLite_Sniffs_PHP_WhiteSpace_ObjectOperatorIndentSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class XLite_Sniffs_PHP_WhiteSpace_ObjectOperatorIndentSniff extends XLite_ReqCodesSniff
{
            ...
            if ($origBrackets === $brackets && $origConditions === $conditions) {
                ...
                if ($indent['code'] === T_WHITESPACE) {
                    ...
                    if ($foundIndent !== $requiredIndent) {
                        ...
                        $phpcsFile->addError($this->getReqPrefix('REQ.PHP.2.12.2') . $error, $next);
                    }
                }
                ...
                if ($tokens[$content]['line'] !== $tokens[$next]['line']) {
                    ...
                    $phpcsFile->addError($this->getReqPrefix('REQ.PHP.2.12.1') . $error, $next);
                }
            }//end if
