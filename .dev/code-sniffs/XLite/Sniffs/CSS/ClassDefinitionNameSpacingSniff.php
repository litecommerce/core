<?php
/**
 * XLite_Sniffs_CSS_ClassDefinitionNameSpacingSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class XLite_Sniffs_CSS_ClassDefinitionNameSpacingSniff extends XLite_ReqCodesSniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        for ($i = ($stackPtr - 1); $i >= 0; $i--) {
			...
			#TODO:  в процессе работы определиться нужен ли этот снифф вообще
			#		если да, то поправить чтобы работал правильно
            ...
            if ($foundContent === false) {
                ...
                if ($prev !== false
                    ...
                    $error = 'Наличие пустых строк недопустимо между названиями классов';
