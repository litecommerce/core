...
let g:pdv_re_attribute = '^\s*\(\(private\|public\|protected\)\+\s*\(\(var\|static\)*\)\)\s*\$\([^ ;=]\+\)[ =]*\(.*\);\?$'
...
func! PhpDocFunc()
    ...
    exe l:txtBOL . g:pdv_cfg_CommentSep . g:pdv_cfg_EOL
	...
	while (l:parameters != ",") && (l:parameters != "")
		...
		let maxParamTypeLength = max([maxParamTypeLength, strlen(l:paramtype)])
		let maxParamNameLength = max([maxParamNameLength, strlen(l:paramname)])

		let paramsData += [[l:paramtype, l:paramname]]
	endwhile

	for data in paramsData
		exe l:txtBOL . g:pdv_cfg_Commentn . "@param " . data[0] . repeat(" ", maxParamTypeLength - strlen(data[0])) . " $" . data[1] . repeat(" ", maxParamNameLength - strlen(data[1])) . " " . g:pdv_cfg_ParamComm . g:pdv_cfg_EOL
	endfor
    ...
    "endif
	exe l:txtBOL . g:pdv_cfg_Commentn . "@see    " . g:pdv_cfg_FuncSee . g:pdv_cfg_EOL
...
func! PhpDocVar()
	...
	let l:varname = substitute (l:name, g:pdv_re_attribute, '\5', "g")
	let l:default = substitute (l:name, g:pdv_re_attribute, '\6', "g")
	...
	exe l:txtBOL . g:pdv_cfg_Commentn . "@see   " . g:pdv_cfg_VarSee . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . "@since " . g:pdv_cfg_Since . g:pdv_cfg_EOL
...
"	exe l:txtBOL . g:pdv_cfg_Commentn . "@license    " . g:pdv_cfg_License . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . "@see   " . g:pdv_cfg_ClassSee . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . "@since " . g:pdv_cfg_Since . g:pdv_cfg_EOL
