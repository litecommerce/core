...
class XLite_Web_Customer_AddressBook extends XLite_Web_Customer_ACustomer
{
    ...
    public function testAddressBookAdd()
    {
        ...
        $this->assertElementPresent("//div[@class='address-box']/descendant::td[@class='address-text']/ul[@class='address-entry']/li[@class='address-text-cell address-text-street']/ul[@class='address-text']/li[@class='address-text-value' and contains(text(), 'test1')]", 'New address is not presented (test1)');
        ...
        // Check if new address is presented in the addresses list
        $this->assertElementPresent("//div[@class='address-box']/descendant::td[@class='address-text']/ul[@class='address-entry']/li[@class='address-text-cell address-text-street']/ul[@class='address-text']/li[@class='address-text-value' and contains(text(), 'test3')]", 'New address is not presented (test3)');
        ...
        // Check if new address is presented in the addresses list
        $this->assertElementPresent("//div[@class='address-box']/descendant::td[@class='address-text']/ul[@class='address-entry']/li[@class='address-text-cell address-text-street']/ul[@class='address-text']/li[@class='address-text-value' and contains(text(), 'test5')]", 'Address is not updated (test5)');
    }
