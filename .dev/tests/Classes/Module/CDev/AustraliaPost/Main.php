...
class XLite_Tests_Module_CDev_AustraliaPost_Main extends XLite_Tests_TestCase
{
    ...
    {
        $main = $this->getMain();
        $this->assertEquals('1.0.3', $main::getVersion(), 'Wrong version');
    }
    ...
    {
        return 'XLite\Module\CDev\AustraliaPost\Main';
    }
