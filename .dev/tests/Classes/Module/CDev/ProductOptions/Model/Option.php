...
class XLite_Tests_Module_CDev_ProductOptions_Model_Option extends XLite_Tests_TestCase
{
    protected $product;
    ...
    public function testDelete()
    {
        ...
        $group = \XLite\Core\Database::getRepo('XLite\Module\CDev\ProductOptions\Model\Option')
            ->find($id);
    ...
    public function testMultilanguage()
    {
        ...
        $t = new XLite\Module\CDev\ProductOptions\Model\OptionTranslation();
        $t->setOwner($option);
        $t->setCode('de');
        $t->setName('de1');
