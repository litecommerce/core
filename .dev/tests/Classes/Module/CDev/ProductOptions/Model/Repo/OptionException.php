...
class XLite_Tests_Module_CDev_ProductOptions_Model_Repo_OptionException extends XLite_Tests_TestCase
{
    protected $product;
    ...
    public function testGetNextExceptionId()
    {
        ...
        $e2 = new XLite\Module\CDev\ProductOptions\Model\OptionException();
        $e2->setOption(
