...
class XLite_Tests_Module_ProductOptions_Model_Repo_OptionSurcharge extends XLite_Tests_TestCase
{
    protected $product;
    ...
    public function testGetSurchargeTypes()
    {
        ...
        $repo = \XLite\Core\Database::getRepo('XLite\Module\ProductOptions\Model\OptionSurcharge');
