...
class XLite_Tests_Module_FeaturedProducts_Model_FeaturedProduct extends XLite_Tests_TestCase
{
    protected $product;
    ...
    public function testCreate()
    {
        ...
        $allFeatured = \XLite\Core\Database::getRepo('\XLite\Module\FeaturedProducts\Model\FeaturedProduct')
    ...
    public function testUpdate()
    {
        ...
        $links = \XLite\Core\Database::getRepo('\XLite\Module\FeaturedProducts\Model\FeaturedProduct')
    ...
    {
        $fProduct = new \XLite\Module\FeaturedProducts\Model\FeaturedProduct();
