...
class XLite_Tests_Module_FeaturedProducts_Model_Repo_FeaturedProduct extends XLite_Tests_TestCase
{
    protected $product;
    ...
    public function testGetFeaturedProducts($categoryId = 0)
    {
        ...
        $fps = \XLite\Core\Database::getRepo('\XLite\Module\FeaturedProducts\Model\FeaturedProduct')
