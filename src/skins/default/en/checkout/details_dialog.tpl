{* Checkout page: order details *} <table border=0>
...
<p><widget class="CButton" label="Modify address information" href="cart.php?target=profile&mode=modify&returnUrl={url:u}" font="FormButton"></p>

<p><widget class="CButton" label="Change payment method" href="cart.php?target=checkout&mode=paymentMethod" font="FormButton"></p>

<p>
<widget template="checkout/credit_card.tpl" visible="{cart.paymentMethod.formTemplate=#checkout/credit_card.tpl#}">
<widget template="modules/SagePay/checkout.tpl"  visible="{cart.paymentMethod.formTemplate=#modules/SagePay/checkout.tpl#}" />
