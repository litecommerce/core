...
<tr>
	<td bgcolor="#A76C28">
		<table border="0" cellpadding="1" cellspacing="0" width="100%" style="background: url('{xlite.layout.path}/images/custom/bgcenter.gif');">
		<tr>
			<td colspan="2" height="15" style="background:url('{xlite.layout.path}images/custom/modules/Promotion/coupon_head.gif'); border-bottom: 1px solid #A76C28;" valign="bottom" align="center">&nbsp;&nbsp;<font color="#2F0000">Discount coupon</font>&nbsp;&nbsp;</td>
        </tr>

		<tr>
			<td style="height: 80px;" class="DialogBox" width="50" align="center" valign="middle">
				<img height="61" width="56" src="images/custom/modules/Promotion/coupon.gif" border="0" alt="">
			</td>
			<td style="height: 80px;" class="DialogBox" align="center" width="150" valign="middle">
                ...
                {end:}
				<br>
				<a href="cart.php?target=cart&amp;action=discount_coupon_delete"><img width="59" height="15" border="0" src="images/custom/modules/Promotion/delete_button.gif" alt=""></a>
			</td>
		</tr>
		</table>
	</td>
