...
<form action="{buildUrl(#advanced_search#)}" method="POST" name="adsearch_form" id="adsearch_form">
  ...
  <table cellpadding="0" cellspacing="10" width="600">
    ...
    <tr>
      <td>Category:</td>
      <td colspan="3"> <widget template="modules/CDev/AdvancedSearch/select_category.tpl" class="\XLite\View\CategorySelect" fieldName="search[category]" allOption search="{search}"></td>
      <td>&nbsp;</td>
    </tr>
