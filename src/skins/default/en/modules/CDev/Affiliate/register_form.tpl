...
<tr valign="middle">
    ...
    <td>
		<widget class="\XLite\View\StateSelect" field="billing_state" value="{billing_state}" fieldId="billing_state_id">
    </td>
    <td>
        &nbsp;
...
<widget class="\XLite\Module\CDev\Affiliate\View\PartnerField" template="modules/CDev/Affiliate/partner_field.tpl" formField="partner_fields" partnerFields="{partnerFields}">
