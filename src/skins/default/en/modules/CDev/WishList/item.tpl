...
<tr>
	...
	<td>
	    ...
	    <tr id="description">
		    <td colspan=3>
				<widget module="CDev\ProductOptions" template="modules/CDev/ProductOptions/selected_options.tpl" IF="{item.hasOptions()}" item="{item}">
		    </td>
		</tr>
		<tr>
			<td colspan=3>&nbsp;</td>
		...
		<tr>
			...
			<tr>
				...
				<td nowrap>
            		<widget class="\XLite\View\Button" template="modules/CDev/WishList/common/button.tpl" label="Update amount" href="javascript: document.update{key}_form.submit();" font="FormButton">
				</td>
				<td width="100%">
            		<widget class="\XLite\View\Button" template="modules/CDev/WishList/common/button.tpl" label="Remove" href="javascript: document.update{key}_form.action.value='delete'; document.update{key}_form.submit();" font="FormButton">
				</td>														
			</tr>
			</table>
			</td>
