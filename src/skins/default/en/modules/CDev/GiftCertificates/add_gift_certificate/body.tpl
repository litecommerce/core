 ...
 * @since     3.0.0
 *}
<widget class="\XLite\Module\CDev\GiftCertificates\View\AddStatesInfo" />
...
function checkEmailAddress(field) {
	...
	if (goodAmount==-1 || document.gccreate.amount.value<{config.CDev.GiftCertificates.minAmount} || document.gccreate.amount.value>{config.CDev.GiftCertificates.maxAmount})
	 {
...
<td colspan="3"><br>
<widget class="\XLite\Module\CDev\GiftCertificates\View\SpambotArrest" id="on_add_giftcert{gc.gcid}">
</td>    
</tr>
