...
<table cellpadding="3" cellspacing="0" border="0">
	<tr>
		...
		<td><widget class="CRequiredValidator" field="sender_name" value="{sender_name}"></td>
	</tr>
	<tr>	
        <td class="NumberOfArticles">Your e-mail:</td> 
		<td width="10"><font class="Star">*</font></td>
        <td><input type="text" name="sender_email" size="32" value="{senderEmail}"></td>
        <td><widget class="CEmailValidator" field="sender_email"></td>
	</tr>	
	<tr>
        <td class="NumberOfArticles">Friend's e-mail:</td>
		<td width="10"><font class="Star">*</font></td>
        <td><input type="text" name="recipient_email" size="32" value="{recipient_email}"></td>
        <td><widget class="CEmailValidator" field="recipient_email"></td>
	</tr>	
	<tr>
		<td>&nbsp;</td>
        <td colspan="2"><br><widget class="CButton" label="Send to friend" href="javascript: document.send{product_id}_form.submit();" img="modules/WishList/letter_icon.gif" font="FormButton"></td>
		<td>&nbsp;</td>
	</tr>
</table>
</form>
