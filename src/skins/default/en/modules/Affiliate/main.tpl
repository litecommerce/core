...
<widget target="partner_profile" mode="modify" template="modules/Affiliate/dialog.tpl" body="modules/Affiliate/modify_profile.tpl" head="Modify profile" class="CRegisterForm" name="profileForm">
