{* Contains the partner zone layout and the page header *}
<!-- [begin] -->
...
<widget IF="config.Affiliate.registration_enabled" target="partner_profile" mode="register" class="CRegisterForm"  template="modules/Affiliate/dialog.tpl" body="modules/Affiliate/register_form.tpl" head="A new partner" name="registerForm"/>
