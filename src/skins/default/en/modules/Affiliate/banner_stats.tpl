...
<tr>
    <td>Period from:</td>
    <td><widget class="CDate" field="startDate"></td>
</tr>    
<tr>
    <td>Period to:</td>
    <td><widget class="CDate" field="endDate"></td>
</tr>    
<tr>
    <td>Sort by:</td>
    <td>
...
<tr FOREACH="stats,key,stat" class="{getRowClass(key,#TableRow#,##)}">
    ...
    {if:stat.product}
        ...
        &lt;&lt; Deleted product &gt;&gt;
        {else:}
		Product <a href="cart.php?target=product&product_id={stat.product.product_id}"><u>&quot;{stat.product.name:h}&quot;</u></a>
        {end:}
    {end:}
    {if:stat.banner}
...
<span IF="search&!stats">no statistics found</span>
