...
<tr valign="middle">
    ...
    <td>
		<widget class="CStateSelect" field="billing_state" value="{billing_state}">
    </td>
    <td>
        &nbsp;
...
<widget class="CPartnerField" template="modules/Affiliate/partner_field.tpl" formField="partner_fields" partnerFields="{partnerFields}" partner="{profile}">
