...
<tr>
    <td colspan="2">
        <widget class="CButton" label="Re-enter address" href="javascript:document.suggest_form.submit();" font="FormButton">
    </td>
{if:suggestionExists}
</tr>
<tr>
    <td>
        <widget class="CButton" label="Use suggestion" href="javascript:document.suggest_form.action_type.value=1;document.suggest_form.submit();" font="FormButton">
    </td>
{end:}
    <td>
        <widget class="CButton" label="Keep current address" href="javascript:document.suggest_form.action_type.value=2;document.suggest_form.submit();" font="FormButton">
    </td>
</tr>
</table>
<hr>
<widget template="modules/UPSOnlineTools/bottom.tpl">
