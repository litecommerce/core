...
<widget module="CDev\Bestsellers" class="\XLite\Module\CDev\Bestsellers\View\Bestsellers" template="common/dialog.tpl" name="bestsellerswidget" IF="{!config.Bestsellers.bestsellers_menu}">
...
<widget module="CDev\WishList" target="product" head="Send to a friend" template="common/dialog.tpl" body="modules/CDev/WishList/send_to_friend.tpl">
