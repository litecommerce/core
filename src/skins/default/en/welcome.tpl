...
<p align="justify">This demo online store running a powerful LiteCommerce store builder engine is based on PHP5 template technology bundled with an SQL database. If you order the LiteCommerce software, you will be able to setup a web store having all of the features this demo has. To test-drive this store, you can browse categories, add/remove products and view our help pages. You can even issue a test order. Feel free to test anything you like.
</p>
