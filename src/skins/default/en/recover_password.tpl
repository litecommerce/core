...
<tr>
    ...
    <td height="10"><input type="text" name="email" value="{email:r}" size="30"><widget class="CEmailValidator" field="email"></td>
</tr>
<tr IF="noSuchUser">
    <td colspan="2">&nbsp;</td>
...
<tr>
    <td colspan="2">&nbsp;</td>
    <td><widget class="CSubmit" href="javascript: document.recover_password.submit()" font="FormButton"></td>
</tr>
</table>
