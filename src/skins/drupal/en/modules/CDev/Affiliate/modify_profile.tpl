...
<tr valign="middle">
    ...
    <td>
        <select class="FixedSelect" disabled>
            <option FOREACH="xlite.factory.\XLite\Module\CDev\Affiliate\Model\AffiliatePlan.findAll(),ap" value="{ap.plan_id}" selected="{ap.plan_id=pending_plan}">{ap.title:h}</option>
        </select>
