...
<widget module="Bestsellers" class="\XLite\Module\Bestsellers\View\Bestsellers" template="common/dialog.tpl" body="modules/Bestsellers/body.tpl" IF="{!config.Bestsellers.bestsellers_menu}" name="bestsellerswidget">
