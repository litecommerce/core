      ...
      <table>
        ...
        <tr>
        	...
        	<td>
              ...
              &nbsp;
              <widget class="\XLite\View\Button\Regular" label="{t(#Delete the image#)}" jsCode="images_form.image_id.value='{image.getId()}'; images_form.action.value='delete_image'; images_form.submit()" />
	        </td>
        </tr>
