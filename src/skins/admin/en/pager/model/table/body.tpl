...
<div class="left">
  ...
  <div class="input"><input type="text" name="pageId" value="{preprocessPageId(pageId)}" class="validate[maxSize[6],min[1],custom[integer]] wheel-ctrl no-wheel-mark not-significant" /></div>
