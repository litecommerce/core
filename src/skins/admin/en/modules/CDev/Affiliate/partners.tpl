        ...
        <tr>
            ...
            <td>    
                <select name="plan_id">
                    ...
                    <option FOREACH="xlite.factory.\XLite\Module\CDev\Affiliate\Model\AffiliatePlan.findAll(),ap" value="{ap.plan_id}" selected="{ap.plan_id=plan_id}">{ap.title:h}</option>
                </select>
    ...
    <tr>
        ...
        <td>
            <select name=new_plan>
                ...
                <option FOREACH="xlite.factory.\XLite\Module\CDev\Affiliate\Model\AffiliatePlan.findAll(),ap" value="{ap.plan_id}">{ap.title:h}</option>
            </select>
        </td>
    </tr>
    <tr>
