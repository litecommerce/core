...
{**
 * Related products management page template
 *  
    ...
    <tr>
      <td bgcolor=#dddddd>
        ...
        <table cellpadding=2 cellspacing=1 border=0 width="100%">
          ...
          <tbody bgcolor=#ffffff FOREACH="getRelatedProducts(product.product_id),RP">
        		...
        		<tr>
        			...
        			<td nowrap>
        				...
        				<widget module="CDev\ProductAdviser" template="modules/CDev/ProductAdviser/product_list.tpl" product="{RP.product}" />
        			</td>
...
-->
  ...
  <span IF="products"><a name="productsList"></a></span>
        ...
        <tr>
          <td bgcolor=#dddddd>
            ...
            <table cellpadding=2 cellspacing=1 border=0 width="100%">
              ...
              <tbody bgcolor=#ffffff FOREACH="products,key,product">

                <tr bgcolor="#{getRowClass(key,#eeeeff#,#ffffff#)}">
            			...
            			<td>{product.name:h}<widget module="CDev\ProductAdviser" template="modules/CDev/ProductAdviser/product_list.tpl" product="{product}"></td>
