...
<table border=0>
<tr><td>Receivable Account number</td><td><font class="star">* <input type="text" name="receivable_account" value="{config.ImportExport.receivable_account}" size=7></td></tr>
<tr><td>G/L Account number</td><td><font class="star">* <input type="text" name="sales_account" value="{config.ImportExport.sales_account}" size=7></td></tr>
</table>
</form>
...
Cash Account number <font class="star">* <input type="text" name="cash_account" value="{config.ImportExport.cash_account}" size=7>
</form>
