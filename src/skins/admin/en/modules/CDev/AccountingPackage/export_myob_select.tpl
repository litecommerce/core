...
<p><span class="admin-head">Step 1: Export of customer cards</span>
...
<p><span class="admin-head">Step 2: Export of sales transaction</span>
...
<p><span class="admin-head">Step 3: Export of received payments</span>
