...
{if:order.processed}
,CUST-{if:order.origProfile}{order.origProfile.profile_id}{else:}{order.profile.profile_id}{end:},,{order.order_id},{formatDate(order,#date#)},{order.paymentMethod.name:h},{cash_account},{order.total},,,-{order.total},,FALSE,FALSE,,1,{order.order_id},0.00,0.00,,,,0.00,0,-{order.total},,,24,{order.order_id},,,,,,,,,,,,0,,0.00{crlf}
{end:}
{end:}
