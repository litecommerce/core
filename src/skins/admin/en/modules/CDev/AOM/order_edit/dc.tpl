...
<tr height="25">
	<td IF="target=#order#" class="ProductDetailsTitle" valign="top">{if:order.orderDC}<widget DC="{order.orderDC}" template="modules/CDev/AOM/coupon_info.tpl">{else:}No discount coupon applied{end:}</td>
	<td IF="target=#order#">&nbsp;</td>
	<td class="ProductDetailsTitle" valign="top">
	{if:cloneOrder.orderDC}<widget DC="{cloneOrder.orderDC}" template="modules/CDev/AOM/coupon_info.tpl" clone="1">{else:}No discount coupon applied{end:}
	</td>
	</tr>
</table>
<br>
...
<span IF="discountCoupons">
    <widget class="\XLite\View\PagerOrig" data="{discountCoupons}" name="pager">
