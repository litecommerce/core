...
<widget module="CDev\WholesaleTrading" template="modules/CDev/AOM/order_edit/wholesale_totals.tpl">
<tr class="{getRowClass(#0#,#TableRow#)}" height="25">  
    <td><b>Subtotal</b></td>
    <td IF="target=#order#">{price_format(order.subtotal):h}</td>
    <td>{price_format(cloneOrder.subtotal):h}</td>
</tr>
<widget module="CDev\Promotion" template="modules/CDev/AOM/order_edit/promotion_totals.tpl">
<widget module="CDev\GiftCertificates" template="modules/CDev/AOM/order_edit/gc_totals.tpl">
<tr class="{getRowClass(#0#,#TableRow#)}" height="25">
...
<widget module="CDev\Promotion" template="modules/CDev/AOM/order_edit/promotion_bonus_points.tpl">
<tr class="{getRowClass(#0#,#TableRow#)}" height="25">
    <td><b>Total</b></td>
