...
<tr>
	<td valign="top" IF="target=#order#&order.orderGC">
		<span width="100%" FOREACH="order.orderGC,key,gc">
			<widget template="modules/CDev/AOM/gift_info.tpl" gc="{gc}">
		</span>
	</td>
	...
	<td valign="top" IF="cloneOrder.orderGC">
        <span width="100%" FOREACH="cloneOrder.orderGC,key,gc">
            <widget template="modules/CDev/AOM/gift_info.tpl" gc="{gc}" clone="1">
        </span>
		<table>
			<tr>
				<td>
...
<tr>
    ...
    {if:!order.gc.validate()=#1#}
		<widget template="modules/CDev/AOM/gift_info.tpl" gc="{order.GC}">
    {else:}
	...
	<td valign="top" IF="cloneOrder.getGCCopy()">
		...
		<widget template="modules/CDev/AOM/gift_info.tpl" gc="{cloneOrder.getGCCopy()}">
		<table>
			<tr>
				<td>
					<input type="submit" value=" Delete ">
...
<span IF="giftCertificates">
	<widget class="\XLite\View\PagerOrig" data="{giftCertificates}" name="pager">
