...
<span id="products">
<widget template="modules/CDev/AOM/order_edit/products.tpl">
</span>
<span id="profile" style="display: none;">
<widget template="modules/CDev/AOM/order_edit/profile.tpl">
</span>
<span id="totals" style="display: none;">
<widget template="modules/CDev/AOM/order_edit/totals.tpl">
</span>
<span id="gc" style="display: none;">
<widget module="CDev\GiftCertificates" template="modules/CDev/AOM/order_edit/gc.tpl">
</span>
<span id="dc" style="display: none;">
<widget module="CDev\Promotion" template="modules/CDev/AOM/order_edit/dc.tpl">
</span>
