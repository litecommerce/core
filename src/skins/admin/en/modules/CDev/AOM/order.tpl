...
<widget template="modules/CDev/AOM/order_info.tpl">
<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    <tr>
        <td align="right">
			...
			<widget module="CDev\UPSOnlineTools" template="modules/CDev/UPSOnlineTools/show_container_details.tpl" style="button">
