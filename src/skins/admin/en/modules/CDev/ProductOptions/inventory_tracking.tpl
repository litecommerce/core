...
<widget module="CDev\InventoryTracking" template="modules/CDev/InventoryTracking/inventory_sku.tpl" ignoreErrors>
<tr>
    <td valign=top>Quantity in stock</td>
    <td valign=top> <input type="text" name="optdata[amount]" value="{ivt.amount}"></td>
</tr>
<widget module="CDev\ProductAdviser" template="modules/CDev/ProductAdviser/inventory_changed.tpl" IF="{isNotifyPresent(ivt.inventory_id)}" dialog="{dialog}" inventory="{ivt}">
<tr>
...
<widget module="CDev\InventoryTracking" template="modules/CDev/InventoryTracking/inventory_sku.tpl" newInventory ignoreErrors>
<tr>
