...
function newTemplate()
{
    ...
    if (new_name != null && new_name != "") {
        window.open("admin.php?target=template_editor&editor=advanced&zone=default&action=new_file&node=skins/mail/en/modules/CDev/GiftCertificates/ecards&file=" + new_name + ".tpl");
    }
}
function editTemplate()
{
    ...
    if (new_name != null && new_name != "") {
        window.open("admin.php?target=template_editor&editor=advanced&zone=default&mode=edit&file=skins/mail/en/modules/CDev/GiftCertificates/ecards/" + new_name + ".tpl");
    }
    }
}
