...
<tr>
	<td colspan="3"><widget template="modules/CDev/eSelect/separator.tpl" caption="Account settings"></td>
</tr>
<tr>
...
<tr>
	<td colspan="3"><widget template="modules/CDev/eSelect/separator.tpl" caption="Transaction settings"></td>
</tr>
...
<tr>
	<td colspan="3"><widget template="modules/CDev/eSelect/separator.tpl" caption="Authentication settings"></td>
</tr>
