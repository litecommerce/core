...
<widget template="modules/CDev/EcommerceReports/period_form.tpl">

<widget template="modules/CDev/EcommerceReports/categories_form.tpl">
...
<tr>
    ...
    <td>
        ...
        <widget template="modules/CDev/EcommerceReports/checker.tpl" selector="country_selector">
...
<tr>
    ...
    <td>
        ...
        <widget template="modules/CDev/EcommerceReports/checker.tpl" selector="state_selector">
    </td>
</tr>

<widget module="CDev\ProductOptions" template="modules/CDev/EcommerceReports/options_form.tpl">
...
<tr FOREACH="productSales,pidx,ps" valign=top class="{getRowClass(pidx,#TableRow#,##)}">
	<td>
        ...
        <widget module="CDev\ProductOptions" template="modules/CDev/EcommerceReports/selected_options.tpl" item="{ps.order_item}" IF="{split_options}">
    </td>
