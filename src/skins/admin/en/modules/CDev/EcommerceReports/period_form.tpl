...
<tr>
    ...
    <td>
        <widget template="modules/CDev/EcommerceReports/period_js.tpl">
...
<tr>
    ...
    <td nowrap><widget class="\XLite\View\Date" template="modules/CDev/EcommerceReports/form_date.tpl" field="startDate" id_prefix="search_"></td>
</tr>
<tr>
    <td nowrap>Date through:</td>
    <td nowrap><widget class="\XLite\View\Date" template="modules/CDev/EcommerceReports/form_date.tpl" field="endDate" id_prefix="search_"></td>
</tr>
</tbody>
<widget template="modules/CDev/EcommerceReports/period_init_js.tpl">
