...
<widget template="modules/CDev/EcommerceReports/categories_form.tpl" label="Purchased products from categories:">
...
<widget module="CDev\Promotion" template="modules/CDev/EcommerceReports/coupon_form.tpl">

<widget moule="GiftCertificates" template="modules/CDev/EcommerceReports/gc_form.tpl">
