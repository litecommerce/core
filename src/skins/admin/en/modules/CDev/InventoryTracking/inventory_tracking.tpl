...
<widget module="CDev\ProductAdviser" template="modules/CDev/ProductAdviser/inventory_changed.tpl" IF="{isNotifyPresent(inventory.inventory_id)}" dialog="{dialog}" inventory="{inventory}">
<tr>
    <td valign="middle" class=ProductDetails>
	Low stock limit *
	</td>
