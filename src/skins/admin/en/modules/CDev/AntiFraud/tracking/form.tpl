...
<table width="100%" cellpadding="0" cellspacing="4" border="0">
    ...
    <tr>
        ...
        <td>State:</td>
        <td align="right"><widget class="\XLite\View\StateSelect" field="state" state="{order.profile.billing_state:h}" isLinked=1 /></td>
    </tr>   	
    <tr>
        <td>IP Country:</td>
        <td>{if:response.data.country}{response.data.country}{else:}n/a{end:}</td>
        <td>Country:</td>
        <td align="right"><widget class="\XLite\View\CountrySelect" field="country" country="{order.profile.billing_country:h}" /></td>
    </tr>   
    <tr>
        <td>IP Zipcode:</td>
