...
<tr>
	...
	<td>
	<widget class="\XLite\Module\CDev\WholesaleTrading\View\CategorySelect" fieldName="bulk_categories[]" template="modules/CDev/WholesaleTrading/multiselect_category.tpl">
	</td>
</tr>
<tr>
