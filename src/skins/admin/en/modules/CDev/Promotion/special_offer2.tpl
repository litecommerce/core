...
<tr>
	...
	<td>
        ...
        <widget class="\XLite\Validator\PatternValidator" template="modules/CDev/Promotion/amount_validator.tpl" field="amount" pattern="/^[1-9][0-9.]*$/">
	</td>
</tr>
</table>
{end:}
...
Minimum order subtotal: <input type="text" name="amount" value="{amount}" size="6"><widget class="\XLite\Validator\PatternValidator" template="modules/CDev/Promotion/amount_validator.tpl" field="amount" pattern="/^[1-9][0-9.]*$/"><br>
{end:}
...
<tr>
	...
	<td>
		<widget class="\XLite\Module\CDev\Promotion\Validator\PromotionMembershipValidator" field="customer_memberships"> 
	</td>
</tr>
</table>
{end:}
