...
<widget class="\XLite\Module\CDev\XPaymentsConnector\View\Form\DeployConfiguration" name="deploy" />
  ...
  <p>Copy the value of the Configuration field from X-Payments Online Store Details page, paste the string here and click Deploy. All the connection settings will be automatically specified.</p>
