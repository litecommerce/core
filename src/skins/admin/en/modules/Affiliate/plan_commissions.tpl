...
<tr>
    <td colspan=4>Basic commission rate: <widget template="modules/Affiliate/rate.tpl" pc="{basicCommission}">
    </td>
</tr>
...
<tr FOREACH="CategoryCommissions,cidx,categoryCommission" width="70%" class="{getRowClass(cidx,#TableRow#,##)}">
    ...
    <td><widget template="modules/Affiliate/rate.tpl" pc="{categoryCommission}" itemID="[{categoryCommission.item_id}]"></td>
</tr>
<tr><td colspan=4>&nbsp;</td></tr>
...
<tr><td colspan=4><widget class="CCategorySelect" fieldName="item_id"></td></tr>
<tr><td colspan=4>Category commission rate: <widget template="modules/Affiliate/rate.tpl" pc="{xlite.factory.planCommission}"></td></tr>
...
<tr FOREACH="ProductCommissions,pidx,productCommission" width="70%" class="{getRowClass(pidx,#TableRow#,##)}">
    ...
    <td><widget template="modules/Affiliate/rate.tpl" pc="{productCommission}" itemID="[{productCommission.item_id}]"></td>
</tr>
<tr><td colspan=4>&nbsp;</td></tr>
<tr><td colspan=4><input type=submit name=update value=" Update ">&nbsp;<input type=submit name=delete value=" Delete "></td></tr>
<tr><td colspan=4>&nbsp;</td></tr>
...
<tr><td colspan=4 class=AdminTitle>&nbsp;</td></tr>
<tr><td colspan=4>Product: <widget class="CProductSelect" formName="add_product_commission_form" formField="item"></td></tr>
<tr><td colspan=4>Product commission rate: <widget template="modules/Affiliate/rate.tpl" pc="{xlite.factory.planCommission}"></td></tr>
<tr><td colspan=4><input type=submit value=" Add "></td></tr>
