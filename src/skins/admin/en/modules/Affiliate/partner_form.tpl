...
<tr><td>Field name</td><td class=Star width=10 align=center>*</td><td><input type=text size=32 name="name" value="{name:r}"> <widget class="CRequiredValidator" field="name" visible="{action=#add_field#}"></td></tr>
