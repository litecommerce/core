...
<p>
<span class="SuccessMessage" IF="dialog.updated">Wells Fargo parameters were successfully changed. Please make sure that the Wells Fargo payment method is enabled on the <a href="admin.php?target=payment_methods"><u>Payment methods</u></a> page before you can start using it.</span>
<p>
