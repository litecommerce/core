...
<tr valign="top">
    ...
    <td>
        ...
        <widget class="CImageUpload" field="thumbnail" actionName="images" formName="modify_form" object="{ecard}">
    </td>
</tr>
<tr valign="top">
    ...
    <td>
        ...
        <widget class="CImageUpload" field="image" actionName="images" formName="modify_form" object="{ecard}">
    </td>
</tr>
<tr valign="top">
