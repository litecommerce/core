<widget class="CPager" name="pager" data="{giftCertificates}">
<br>
...
<table border="0" IF="pager.pageData">
<tr>
...
<tr FOREACH="pager.pageData,cert">
	...
	<td>
		{price_format(cert.debit):h}/{price_format(cert.amount):h}
	</td>
	<td>
		{date_format(cert.add_date)}
	</td>
	<td>
		{date_format(cert.expirationDate)}
	</td>
	<td align="center">
