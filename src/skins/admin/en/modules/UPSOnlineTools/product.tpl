...
<table border="0" cellpadding="2" cellspacing="2" width="80%">
	...
	<tr>
		<td colspan="3"><widget template="modules/UPSOnlineTools/settings/separator.tpl" caption="Product dimensions"></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3"><widget template="modules/UPSOnlineTools/settings/separator.tpl" caption="Advanced shipping options"></td>
	</tr>
	<tr>
