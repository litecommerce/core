...
<tr valign="middle">
    ...
    <td><widget class="CRequiredValidator" field="contact_name"></td>
</tr>
...
<tr valign="middle">
    ...
    <td><widget class="CRequiredValidator" field="title_name"></td>
</tr>
...
<tr valign="middle">
    ...
    <td><widget class="CRequiredValidator" field="company"></td>
</tr>
...
<tr valign="middle">
    ...
    <td><widget class="CRequiredValidator" field="address"></td>
</tr>
...
<tr valign="middle">
    ...
    <td><widget class="CRequiredValidator" field="city"></td>
</tr>
...
<tr valign="middle">
	...
	<td><widget class="CRequiredValidator" field="country"></td>
</tr>
...
<tr valign="middle">
    ...
    <td><widget class="CRequiredValidator" field="postal_code"></td>
</tr>
...
<tr valign="middle">
    ...
    <td><widget class="CRequiredValidator" field="phone"></td>
</tr>
...
<tr valign="middle">
    ...
    <td><widget class="CRequiredValidator" field="web_url"></td>
</tr>
...
<tr valign="middle">
    ...
    <td><widget class="CEmailValidator" field="email"></td>
</tr>
