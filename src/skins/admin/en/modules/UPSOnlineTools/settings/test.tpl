...
<tr valign="top">
    ...
    <td>
        ...
        <tr>
            <td>State</td>
            <td>
			    <widget class="CStateSelect" field="destinationState" onChange="{if:useDynamicStates}javascript: changeState(this, 'destination');{end:}" fieldId="destination_state_select" value="{destinationState}">
  			    <widget class="CStateValidator" field="destinationState" countryField="destinationCountry">
            </td>
        </tr>
        ...
        <tr>
            <td>Country</td>
            <td><widget class="CCountrySelect" field="destinationCountry" onChange="{if:useDynamicStates}javascript: populateStates(this,'destination_state');{end:}" fieldId="destination_country_select" value="{destinationCountry}"></td>
        </tr>
