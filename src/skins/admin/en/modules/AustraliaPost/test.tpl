...
<div class="AdminTitle">Test AustraliaPost rates calculation</div>
...
<form action="admin.php#test_" method="get">
  ...
  <table border="0" cellpadding="3" cellspacing="0">
    ...
    <tr>
      <td colspan="2"><br /><b>Destination</b></td>
    </tr>
...
<div IF="testResult">
  ...
  <span class="ErrorMessage" IF="aupost.error">Error #{aupost.error:h}</span>
  ...
  <div IF="rates">
    ...
    <table border="1" cellspacing="0">
      ...
      <tr FOREACH="rates,id,rate">
        <td>{rate.shipping.name}</td>
        <td>{price_format(rate.rate):h}</td>
      </tr>
  ...
  <span IF="!rates">No shipping method is available for specified shipping destination and/or package measurements/weight.</span>
