...
<table border="0" cellpadding="3" cellspacing="0">
    ...
    <tr>
        ...
        <td><widget class="CStatusSelect" field="status" allOption style="width: 100%"></td>
        <td>&nbsp;</td>
	...
	<tr>
		...
		<td colspan="3"><widget class="CDate" field="startDate"></td>
        <td></td>		
	</tr>
    <tr>
        <td class="FormButton">Date through:</td>
        <td colspan="3"><widget class="CDate" field="endDate"></td>
        <td></td>
    </tr>
	</tbody>
	<tr>
