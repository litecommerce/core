...
<tr>
    <td>Expires</td>
    <td><widget class="CDate" field="expire" value="{dc.expire}"></td>
</tr>
<tr>
    ...
    <tr>
        ...
        <td>one product<br><widget class="CProductSelect" formName="coupon_form" product="{dc.product}"></td>
    </tr>
    <tr>
        <td valign="top"><input type="radio" name="applyTo" value="category" checked="{dc.applyTo=#category#}"></td>
        <td>one category <br><widget class="CCategorySelect" fieldName="category_id" selectedCategory="{dc.category_id}"></td>
    </tr>
    </table>
    </td>
</tr>
