  ...
  <tr>
    <td height="15">
      ...
      <table border="0" cellspacing="0" cellpadding="0" height="100%">
        ...
        <tbody FOREACH="getSplittedTabs(#90#),row_idx,row">
            ...
            <td>
                ...
                <tr height="17">
                  ...
                  <td nowrap="nowrap" align="center" valign="center" background="images/tab_bg_a.gif">&nbsp;&nbsp;&nbsp;<a class="PageLink" href="{tabPage.url:h}"><FONT class="tabSelected">{tabPage.title}</FONT></a>&nbsp;&nbsp;&nbsp;</td>
                  <td width="4" background="images/tab_a2.gif">&nbsp;</td>
                      {else:}
                  <td width="3" background="images/tab_p1.gif"></td>
                  <td nowrap="nowrap" align="center" valign="center" background="images/tab_bg_p.gif">&nbsp;&nbsp;&nbsp;<a class="PageLinkDefault" href="{tabPage.url:h}"><FONT class="tabDefault">{tabPage.title}</FONT></a>&nbsp;&nbsp;&nbsp;</td>
