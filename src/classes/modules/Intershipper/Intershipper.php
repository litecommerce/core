...
* @access public
* @version $Id: Intershipper.php,v 1.21 2008/10/23 11:56:08 sheriff Exp $
*/
class Module_Intershipper extends Module
{
    ...
    {
        // check license
        if(!check_module_license("Intershipper", true)) return;
