...
* @package 
* @access
* @version $Id: order_list.php,v 1.5 2008/10/23 11:51:42 sheriff Exp $
*/

class Module_AntiFraud_Admin_Dialog_order_list extends Admin_Dialog_order_list
{
		function init()
		{
	    ...
	    function &getOrders() 
		{
			...
			if (!is_null($orders)&&$this->show_factor) {
				foreach ($orders as $key => $order) { 
					if (!is_object($order)) {
						$order = func_new("Order", $order['data']['order_id']);
					}
