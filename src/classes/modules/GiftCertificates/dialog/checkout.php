...
* @access public
* @version $Id: checkout.php,v 1.2 2008/10/23 11:54:43 sheriff Exp $
*/
class Module_GiftCertificates_Dialog_checkout extends Dialog_checkout
{
    ...
    function checkCertificatesExpiration()
    {
        ...
        $gcs = (array) $gc->findAll($where, $orderby="expiration_date", $groupby=null, $limit='10');
        foreach ($gcs as $_gc) {
            $_gc->isDisplayWarning();
        }
    }
}
// WARNING :
