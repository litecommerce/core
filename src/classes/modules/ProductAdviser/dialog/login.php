...
/**
* Dialog_login_ProductAdviser description.
*
* @package Module_ProductAdviser
* @access public
* @version $Id: login.php,v 1.3 2008/10/23 11:58:28 sheriff Exp $
*/
class Dialog_login_ProductAdviser extends Dialog_login
{
    function init()
    {
    	parent::init();
