...
/**
* Module_Promotion_Cart description.
*
* @package Module_Promotion
* @access public
* @version $Id: Cart.php,v 1.55 2009/09/22 11:33:13 fundaev Exp $
*/
class Module_Promotion_Cart extends Cart
{
	var $_originalItems = false;
    var $doNotCallCartChanged = false;
    var $doNotCallConstructorCalcTotal = false;
		...
		foreach ($add as $product_id => $bonusAmount) {
			...
			foreach ($keys as $key => $tempo) {
				...
				if (is_object($regularItem)) {
					...
					$regularItem1 = func_new("OrderItem");
					$regularItem1->set("properties", $reg_props);
					$regularItem2 = func_new("OrderItem");
