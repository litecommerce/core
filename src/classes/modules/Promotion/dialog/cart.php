...
* @access public
* @version $Id: cart.php,v 1.17 2008/10/23 11:59:22 sheriff Exp $
*/
class Module_Promotion_Dialog_cart extends Dialog_cart
{
	...
	{
		return is_null($this->cart->get("DC")) && !$this->cart->is("empty") && $this->config->get("Promotion.allowDC");
	}
