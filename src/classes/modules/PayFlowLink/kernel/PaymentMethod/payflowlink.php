...
* @access public
* @version $Id: payflowlink.php,v 1.5 2008/10/23 11:57:55 sheriff Exp $
*/
class PaymentMethod_payflowlink extends PaymentMethod_credit_card
{
    ...
    function constructor($id = null) 
    {
        ...
        if ($id) {
            ...
            if (!$this->get("params.gateway_url")) {
    ...
    {
        require_once "modules/PayFlowLink/encoded.php";
