...
* @package View
* @access public
* @version $Id: ButtonAltCheckout.php,v 1.2 2008/10/23 11:55:38 sheriff Exp $
*/
class CButtonAltCheckout extends CButton
{
	var $buttonUrl = null;
	var $gacObject = null;
	...
	function init()
	{
		...
		if (isset($this->gacObject->GCMerchantID) && $this->get("dialog.target") == "cart" && strtolower($this->get("label")) == "checkout") {
