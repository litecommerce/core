...
* @access public
* @version $Id: aupost.php,v 1.3 2008/10/23 11:51:49 sheriff Exp $
*/

class Admin_Dialog_aupost extends Admin_Dialog_shipping_settings // {{{
{
	...
	function action_test() // {{{ 
	{
		...
		if (empty($this->sourceZipcode)) 
			$this->sourceZipcode = $this->config->get("Company.location_zipcode");
