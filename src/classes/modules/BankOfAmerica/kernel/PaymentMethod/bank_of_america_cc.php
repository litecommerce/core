...
/**
* Bank Of America processor unit. This implementation complies the following
*
* @package Module_BankOfAmerica
* @access public
* @version $Id: bank_of_america_cc.php,v 1.7 2008/10/23 11:52:11 sheriff Exp $
*/
class PaymentMethod_bank_of_america_cc extends PaymentMethod_credit_card
{
