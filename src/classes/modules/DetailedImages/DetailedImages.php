...
/**
* This module adds unlimited number of product detailed images.
*
* @package Module_DetailedImages
* @access public
* @version $Id: DetailedImages.php,v 1.40 2008/10/23 11:53:11 sheriff Exp $
*/
class Module_DetailedImages extends Module
{
    var $isFree = true;
    var $minVer = "2.0";
    ...
    function init()
    {
        ...
        $image->registerImageClass("detailed_image", "Detailed images", 
