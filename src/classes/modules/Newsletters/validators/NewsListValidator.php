...
/**
* CNewsListValidator description.
*
* @package Module_Newsletters
* @version $Id: NewsListValidator.php,v 1.6 2008/10/23 11:57:41 sheriff Exp $
*/
class CNewsListValidator extends CRequiredValidator
{
