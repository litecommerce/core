...
/**
* This module greets customer by his name when he returns to the site.
*
* @package Module_GreetVisitor
* @access public
* @version $Id: GreetVisitor.php,v 1.15 2008/10/23 11:55:44 sheriff Exp $
*/
class Module_GreetVisitor extends Module
{
    var $isFree = true;
    var $minVer = "2.0";
