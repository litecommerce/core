...
/**
* Module_PayPalPro_Admin_Dialog_modules description.
*
* @package Module_PayPalOff
* @access public
* @version $Id: modules.php,v 1.4 2008/10/23 11:58:04 sheriff Exp $
*/
class Module_PayPalPro_Admin_Dialog_modules extends Admin_Dialog_modules
{
    function init()
    {
    	parent::init();

    	if ($this->session->get("PayPalOff")) {
    		$this->session->set("PayPalOff", null);
    ...
    function action_update()
    {
        if (isset($_REQUEST["active_modules"])) {
        	...
        	foreach ($modules as $module) {
        		if ($module->get("name") == "PayPal") {
        			$m1 = $module->get("module_id");
        		}
        		if ($module->get("name") == "PayPalPro") {
