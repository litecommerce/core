...
* @access public
* @version $Id: 2CheckoutCom.php,v 1.26 2008/10/23 11:49:28 sheriff Exp $
*/
class Module_2CheckoutCom extends Module
{
    var $minVer = "2.0";
    ...
    function init()
    {
        if(!check_module_license("2CheckoutCom",true)) return;
