...
/**
* Module allows to arrange products in several categories.
*
* @package Module_$Module$
* @access public
* @version $Id: MultiCategories.php,v 1.17 2008/10/23 11:57:08 sheriff Exp $
*/
class Module_MultiCategories extends Module
{
    var $isFree = true;
    var $minVer = "2.1.2";
