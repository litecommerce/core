...
/**
* Admin_Dialog_module_LayoutOrganizer description.
*
* @package Module_LayoutOrganizer
* @access public
* @version $Id: module.php,v 1.3 2008/10/23 11:56:29 sheriff Exp $
*/
class Admin_Dialog_module_LayoutOrganizer extends Admin_Dialog_module
{
	function init()
	{
		parent::init();
