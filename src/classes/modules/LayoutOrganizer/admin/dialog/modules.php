...
/**
* Admin_Dialog_modules_LayoutOrganizer description.
*
* @package Module_LayoutOrganizer
* @access public
* @version $Id: modules.php,v 1.3 2008/10/23 11:56:38 sheriff Exp $
*/
class Admin_Dialog_modules_LayoutOrganizer extends Admin_Dialog_modules
{
    function init()
    {
    	parent::init();

    	if ($this->session->get("ShowcaseOrganizerOff")) {
    		$this->session->set("ShowcaseOrganizerOff", null);
    ...
    function action_update()
    {
        if (isset($_REQUEST["active_modules"])) {
        	...
        	foreach ($modules as $module) {
        		if ($module->get("name") == "ShowcaseOrganizer") {
        			$m1 = $module->get("module_id");
        		}
        		if ($module->get("name") == "LayoutOrganizer") {
