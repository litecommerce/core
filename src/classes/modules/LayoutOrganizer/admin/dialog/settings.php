...
/**
* Admin_Dialog_settings_LayoutOrganizer description.
*
* @package Module_LayoutOrganizer
* @access public
* @version $Id: settings.php,v 1.3 2008/10/23 11:56:42 sheriff Exp $
*/
class Admin_Dialog_settings_LayoutOrganizer extends Admin_Dialog_settings
{
			...
			if (strcmp($newTemplate, $oldTemplate) != 0) {
            	...
            	if (is_array($categories)) {
            		foreach($categories as $cat) {
            			$cat->updateChildrenTemplates(true);
            		}
            	}
        	}
		}
