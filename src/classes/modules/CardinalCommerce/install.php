...
start_patching("CardinalCommerce");

// patching skins/default/en/checkout/credit_card.tpl
$location = "skins/default/en/checkout/credit_card.tpl";
if (!is_template_patched($location, "dialog.SupportedByCardinalCommerce"))
{
	$find_str = <<<EOT
</table>
EOT;
