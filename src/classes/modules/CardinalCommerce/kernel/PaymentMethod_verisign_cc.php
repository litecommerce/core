...
/**
* PaymentMethod_verisign_cc_CardinalCommerce description.
*
* @package Module_CardinalCommerce
* @access public
* @version $Id: PaymentMethod_verisign_cc.php,v 1.4 2008/10/23 11:52:40 sheriff Exp $
*/

class PaymentMethod_verisign_cc_CardinalCommerce extends PaymentMethod_verisign_cc
{
    function initRequest(&$request)
    {
        ...
        if(isset($cmpi_result)) {
        	if(intval($cmpi_result['EciFlag']) === 2)
				...
				$request[] = "ECI=".intval($cmpi_result['EciFlag']);
