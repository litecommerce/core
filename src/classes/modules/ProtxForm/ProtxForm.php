...
* @access public
* @version $Id: ProtxForm.php,v 1.2 2007/07/12 12:07:10 osipov Exp $
*/

class Module_ProtxForm extends Module
{
    var $minVer = "2.0";
    ...
    {
       return "admin.php?target=payment_method&payment_method=protxform_cc";
    }
