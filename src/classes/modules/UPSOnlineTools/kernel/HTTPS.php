...
* @access public
* @version $Id: HTTPS.php,v 1.1 2009/06/08 07:40:09 fundaev Exp $
*/
class HTTPS_UPSOnlineTools extends HTTPS
{
	var $use_ssl3 = false;

	function useSslV3($use)
	{
		$this->use_ssl3 = $use === true;
	}

    function libCurl_init()
    {
        $c = parent::libCurl_init();
		if ($this->use_ssl3 === true)
