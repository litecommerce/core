...
* @access public
* @version $Id: Product.php,v 1.3 2008/10/23 12:02:03 sheriff Exp $
*/
class Module_UPSOnlineTools_Product extends Product
{
	...
	function getWeightConv($unit)
	{
		...
		return UPSOnlineTools_convertWeight($this->get("weight"), $this->config->get("General.weight_unit"), $unit, 2);
	}
