...
/**
* Dialog_beanstream_checkout description.
*
* @package Module_BeanStream
* @access public
*
* @version $Id: beanstream_checkout.php,v 1.3 2008/10/23 11:52:13 sheriff Exp $
*/

class Dialog_beanstream_checkout extends Dialog_checkout
{
	function init()
	{
	...
	{
		$oid = $this->session->get("BeanStreamOrderID");

		if ($oid && $this->get("PaRes") && $this->get("MD")) {
			$this->order = null;
			$_REQUEST["order_id"] = $oid;

			$this->session->set("BeanStreamOrderID", null);
