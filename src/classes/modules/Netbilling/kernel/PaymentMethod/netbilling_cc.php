...
* @access public
* @version $Id: netbilling_cc.php,v 1.5 2008/10/23 11:57:20 sheriff Exp $
*/
class PaymentMethod_netbilling_cc extends PaymentMethod_credit_card
{
	...
	function initRequest(&$cart, &$request) 
	{
		if ($this->xlite->get("cc_initRequestAlternate")) {
			$_object =& func_new("PaymentMethod_netbilling_cc_CardinalCommerce");
