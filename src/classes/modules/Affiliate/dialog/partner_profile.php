...
* @access public
* @version $Id: partner_profile.php,v 1.9 2008/10/30 09:17:29 vgv Exp $
*/
class Dialog_partner_profile extends PartnerDialog
{
    ...
    {
        if (!$this->get("config.Affiliate.registration_enabled")) {
