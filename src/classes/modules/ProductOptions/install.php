...
* @access public
* @version $Id: install.php,v 1.10 2008/11/19 16:18:36 vgv Exp $
*/
...
$check_str = "<span IF=\"{item.weight}\">";
$find_str    = "<widget module=\"ProductOptions\" template=\"modules/ProductOptions/selected_options.tpl\" visible=\"{item.hasOptions()}\" item=\"{item}\">";
$replace_str = "<widget module=\"ProductOptions\" template=\"modules/ProductOptions/selected_options.tpl\" visible=\"{item.hasOptions()}\" item=\"{item}\">\n\n<span IF=\"{item.weight}\">Weight: {item.weight} {config.General.weight_symbol}<br></span>";
...
$check_str = "ProductOptions/product_quantity.tpl";
$find_str = <<<EOT
