...
* @access public
* @version $Id: scheme_manager.php,v 1.3 2008/10/23 11:52:50 sheriff Exp $
*/
class Module_DemoMode_Admin_Dialog_Scheme_Manager extends Admin_Dialog_Scheme_Manager
{
    function init()
    {
