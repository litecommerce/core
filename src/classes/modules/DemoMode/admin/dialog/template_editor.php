...
* @access public
* @version $Id: template_editor.php,v 1.3 2008/10/23 11:52:52 sheriff Exp $
*/
class Module_DemoMode_AD_template_editor_LayoutOrganizer extends Admin_Dialog_template_editor_LayoutOrganizer
{
    function init()
    {
