...
* @access public
* @version $Id: GlobalDiscount.php,v 1.5 2008/10/23 12:04:20 sheriff Exp $
*/
class GlobalDiscount extends Base
{
    /**
    * @var string $alias The product access database table alias.
    * @access public
    */
    var $alias = "global_discount";

    var $primaryKey = array("discount_id");
