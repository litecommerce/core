...
* @access public
* @version $Id: Order.php,v 1.19 2008/11/20 07:45:41 vgv Exp $
*/
class Module_WholesaleTrading_Order extends Order
{
	...
	function &getAppliedGlobalDiscount()
	{
		if (is_null($this->_applied_global_discount)) {
			...
			if (is_null($this->_applied_global_discount)) $this->_applied_global_discount = func_new("GlobalDiscount");
		}
