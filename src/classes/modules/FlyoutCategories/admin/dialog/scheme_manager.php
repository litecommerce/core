...
* @access public
* @version $Id: scheme_manager.php,v 1.3 2008/10/23 11:54:11 sheriff Exp $
*/

class Admin_Dialog_Scheme_Manager_FlyoutCategories extends Admin_Dialog_Scheme_Manager
{
	var $schemes = null;
	var $scheme = null;
