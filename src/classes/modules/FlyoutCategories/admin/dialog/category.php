...
* @package Dialog
* @access public
* @version $Id: category.php,v 1.8 2008/12/22 13:53:39 vgv Exp $
*
*/
class FlyoutCategories_Admin_Dialog_category extends Admin_Dialog_category
{
	...
	function action_delete()
	{
		...
		if ($this->get("category_id") > 0) {
			$c = func_new("Category", $this->get("category_id"));
