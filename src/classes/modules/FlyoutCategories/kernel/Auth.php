...
* @package Kernel
* @access public
* @version $Id: Auth.php,v 1.2 2008/10/23 11:54:15 sheriff Exp $
*/
class Module_FlyoutCategories_Auth extends Auth
{
	...
	function getFlyoutCategoriesCacheDirectory()
	{
		...
		if (is_object($profile) && $profile->get("membership")) {
			...
			$layout_path .= "/modules/FlyoutCategories/catalog$catalog";
