...
*
* @package $Package$
* @version $Id: Order.php,v 1.16 2008/10/23 11:50:22 sheriff Exp $
*/
class Module_AdvancedSecurity_Order extends Order
{
    var $gpg;
    ...
    function update()
    {
        ...
        if (!empty($details) && $this->get("payment_method") == "credit_card" && $this->get("config.AdvancedSecurity.gpg_crypt_db")) {
