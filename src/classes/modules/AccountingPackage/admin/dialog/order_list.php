...
* @access public
* @version $Id: order_list.php,v 1.22 2008/10/23 11:49:55 sheriff Exp $
*/
class Module_AccountingPackage_Admin_Dialog_order_list extends Admin_Dialog_order_list
{
    var $delimiter  = "\t";
    var $crlf       = "\r\n";
