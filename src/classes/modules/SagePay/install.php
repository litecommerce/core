...
* @package SagePay
* @access public
* @version $Id: install.php,v 1.1 2009/07/26 16:40:28 isden Exp $
*/
...
start_patching("SagePay");

$location = "skins/default/en/checkout/details_dialog.tpl";

if (!is_template_patched($location, "SagePay"))
{
	$find_str = <<<EOT
...
EOT;
    patch_template($location, "SagePay", $find_str, $replace_str);
}
else
{
