...
* @access public
* @version $Id: AuthorizeNet.php,v 1.33 2008/10/23 11:51:57 sheriff Exp $
*/
class Module_AuthorizeNet extends Module
{
    var $minVer = "2.0";
    ...
    {
       return "admin.php?target=payment_method&payment_method=authorizenet_cc";
    }
