...
/**
* NetRegistry processor unit. 
*
* @package Module_NetRegistry
* @access public
* @version $Id: netregistry_cc.php,v 1.9 2008/10/23 11:57:18 sheriff Exp $
*/
class PaymentMethod_netregistry_cc extends PaymentMethod_credit_card
{
