...
* abstract class which sends messages to client browser. Use for or the debug
* purposes only.
*
* @package Kernel
* @access public
* @version $Id: client.php,v 1.11 2008/10/23 11:43:59 sheriff Exp $
*/
class Log_client extends Log
{
    /**
    * Constructor.
    *
