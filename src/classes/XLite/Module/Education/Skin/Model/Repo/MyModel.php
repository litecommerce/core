...
namespace XLite\Module\Education\Skin\Model\Repo;

/**
 * The education module data storage repository
 *
 */
class MyModel extends \XLite\Model\Repo\ARepo
{
    const PREFIX_SEARCH_PARAM_HANDLER = 'prepareCnd';
     ...
     * @return boolean
     */
    protected function assembleSearchParamHandler($param)
    {
        return static::PREFIX_SEARCH_PARAM_HANDLER . ucfirst($param);
    }
    ...
    {
        $method = $this->assembleSearchParamHandler($key);

        if (method_exists($this, $method)) {
            $this->{$method}($queryBuilder, $value, $countOnly);
