 ...
 * @since   3.0.0
 */
class XLite_Module_GiftCertificates_Controller_Customer_GiftCertificateInfo extends XLite_Controller_AController
{
    /**
    ...
    /**
     * Gift certificate XLite_Module_GiftCertificates_Model_GiftCertificate 
     * 
     * @var    mixed
     * @access protected
     * @see    ____var_see____
