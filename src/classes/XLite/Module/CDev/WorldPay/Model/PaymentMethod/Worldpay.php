...
namespace XLite\Module\CDev\WorldPay\Model\PaymentMethod;
...
{
    public $configurationTemplate = "modules/CDev/WorldPay/config.tpl";
    public $formTemplate = "modules/CDev/WorldPay/checkout.tpl";
