...
namespace XLite\Module\CDev\GiftCertificates\Model\PaymentMethod;
...
class GiftCertificate extends \XLite\Model\PaymentMethod
{
     ...
     * @since  3.0.0
     */
    public $formTemplate = 'modules/CDev/GiftCertificates/checkout.tpl';
    ...
    public function handleRequest(\XLite\Model\Cart $cart)
    {
        ...
        if ($setResult != \XLite\Module\CDev\GiftCertificates\Model\GiftCertificate::GC_OK) {
