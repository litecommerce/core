...
class GiftCertificates extends \XLite\Controller\Admin\AAdmin
{
     ...
     * 
     * @var    array(\XLite\Module\CDev\GiftCertificates\Model\GiftCertificate)
     * @access protected
     * @see    ____var_see____
     * @since  3.0.0
     */
     ...
     * 
     * @return array(\XLite\Module\CDev\GiftCertificates\Model\GiftCertificate)
     * @access public
    ...
    {
        $gc = new \XLite\Module\CDev\GiftCertificates\Model\GiftCertificate(\XLite\Core\Request::getInstance()->gcid);
        $gc->delete();
    }
