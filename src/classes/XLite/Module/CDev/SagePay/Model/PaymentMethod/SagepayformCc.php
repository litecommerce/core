...
namespace XLite\Module\CDev\SagePay\Model\PaymentMethod;
...
class SagepayformCc extends \XLite\Model\PaymentMethod\CreditCard
{
    ...
    public $configurationTemplate = "modules/CDev/SagePay/config.tpl";
    ...
    {
        return "modules/CDev/SagePay/checkout.tpl";
    }
