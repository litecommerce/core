...
$replace_str = <<<EOT
<widget module="Intershipper" target="intershipper"  template="common/dialog.tpl" body="modules/CDev/Intershipper/test.tpl" head="Intershipper Live Test">
<widget module="AustraliaPost" template="modules/CDev/AustraliaPost/main.tpl">
EOT;
patch_template($location, "AustraliaPost", $find_str, $replace_str);
...
$replace_str = <<<EOT
<widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/location.tpl">
<widget module="AustraliaPost" template="modules/CDev/AustraliaPost/location.tpl">
EOT;
patch_template($location, "AustraliaPost", $find_str, $replace_str);
