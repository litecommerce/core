...
class Product extends \XLite\Model\Product implements \XLite\Base\IDecorator
{
    ...
    function _available_action($action)
    {
        ...
        $result = \XLite\Model\CachingFactory::getObject(
            ...
            '\XLite\Module\CDev\WholesaleTrading\Model\ProductAccess',
            array($productId)
        );
    ...
    {
        $purchase_limit = new \XLite\Module\CDev\WholesaleTrading\Model\PurchaseLimit();
    ...
    */
    function collectGarbage()
    {
        ...
        foreach ($classes as $class) {
            ...
            $className = '\XLite\Module\CDev\WholesaleTrading\Model\\' . $class;
            $obj = new $className();
