...
class Order extends \XLite\Model\Order implements \XLite\Base\IDecorator
{
    ...
    function getAppliedGlobalDiscount()
    {
        if (is_null($this->_applied_global_discount)) {
            ...
            if (is_null($this->_applied_global_discount)) {
                $this->_applied_global_discount = new \XLite\Module\CDev\WholesaleTrading\Model\GlobalDiscount();
            }
        }
    ...
    protected function calculateGlobalDiscount($subtotal)
    {
        ...
        $gd = new \XLite\Module\CDev\WholesaleTrading\Model\GlobalDiscount();
