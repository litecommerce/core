...
EOT;
    $replace_str = <<<EOT
<widget module="ProductOptions" template="modules/CDev/ProductOptions/product_options.tpl" IF="product.hasOptions()&!product.showExpandedOptions"/>
<widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/expanded_options.tpl" IF="product.hasOptions()&product.showExpandedOptions"/>
EOT;
...
EOT;
    $replace_str = <<<EOT
<widget module="WholesaleTrading" mode="update_error" template="common/dialog.tpl" body="modules/CDev/WholesaleTrading/update_error.tpl" head="Product quantities not changed">    
<widget module="WholesaleTrading" target="price_list" template="modules/CDev/WholesaleTrading/pl_main.tpl"> 
<widget module="WholesaleTrading" target="wholesale" template="modules/CDev/WholesaleTrading/wholesale.tpl">
<widget module="WholesaleTrading" target="global_discount" template="common/dialog.tpl" body="modules/CDev/WholesaleTrading/global_discount.tpl" head="Global discounts">
<!-- [/center] -->
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
...
EOT;
    $replace_str = <<<EOT
{*extraFields*}
<widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/profile_form.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
} else {
    already_patched($location);
...
$find_str = <<<EOT
    <widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/invoice.tpl">
    <widget module="Promotion" template="modules/CDev/Promotion/invoice_discount.tpl">
EOT;
...
EOT;
    $replace_str = <<<EOT
        ...
        <widget module=WholesaleTrading template="modules/CDev/WholesaleTrading/wholesaler_details.tpl" profile={order.profile}>
    <tr>
        <td  colspan="2" nowrap bgcolor="#DDDDDD"><b>Products Ordered</b></td>
    </tr>
EOT;
...
EOT;
    $replace_str = <<<EOT
            <widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/print_invoice_discount_label.tpl" ignoreErrors>
            <b>Subtotal</b><br>
EOT;
    patch_template($location, null, $find_str, $replace_str);
} else {
...
EOT;
    $replace_str = <<<EOT
            <widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/print_invoice_discount.tpl" ignoreErrors>
            {price_format(order,#subtotal#):h}<br>
EOT;
    patch_template($location, null, $find_str, $replace_str);
} else {
...
EOT;
    $replace_str = <<<EOT
<table align="right" border=0>
<widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/totals.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
} else {
    already_patched($location);
...
$find_str = <<<EOT
    <widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/invoice.tpl">
    <widget module="Promotion" template="modules/CDev/Promotion/invoice.tpl">
EOT;
if (is_template_patched($location, $find_str)) {
    $replace_str = <<<EOT
    <widget module="Promotion" template="modules/CDev/Promotion/invoice.tpl">
...
if (is_template_patched($location, '<widget module=WholesaleTrading template="modules/CDev/WholesaleTrading/wholesaler_details.tpl">'))
{
    $find_str = <<<EOT
<widget module=WholesaleTrading template="modules/CDev/WholesaleTrading/wholesaler_details.tpl">
EOT;
    $replace_str = <<<EOT
<widget module=WholesaleTrading template="modules/CDev/WholesaleTrading/wholesaler_details.tpl" profile={order.profile}>
EOT;
...
EOT;
    $replace_str = <<<EOT
<widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/main.tpl"> 
<!-- [/center] -->
EOT;
    patch_template($location, null, $find_str, $replace_str);
...
EOT;
    $replace_str = <<<EOT
<hr>
<widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/catalog.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
...
{
    $find_str = <<<EOT
<widget module="GiftCertificates" template="modules/CDev/GiftCertificates/location.tpl">
EOT;
    $replace_str = <<<EOT
<widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/location.tpl">
<widget module="GiftCertificates" template="modules/CDev/GiftCertificates/location.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
} else {
...
EOT;
    $replace_str = <<<EOT
    <td><widget class="CMembershipSelect" field="membership" history="{membership_history}"><widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/membership_history/caption.tpl" membership_history="{membership_history}"></td>
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
...
EOT;
    $replace_str = <<<EOT
<widget module="WholesaleTrading" template="modules/CDev/WholesaleTrading/memberships/profile_expiration.tpl">
...
EOT;
    $replace_str = <<<EOT
<widget module=WholesaleTrading template="modules/CDev/WholesaleTrading/wholesaler_details.tpl" profile={profile}>
</table>
