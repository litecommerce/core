...
class ImportCatalog extends \XLite\Controller\Admin\ImportCatalog implements \XLite\Base\IDecorator
{
    ...
    public function __construct(array $params = array())
    {
        ...
        $this->pageTemplates['import_wholesale_pricing'] = "modules/CDev/WholesaleTrading/import_wholesale_pricing.tpl";
        $this->pages['import_product_access'] = "Import product access";
        $this->pageTemplates['import_product_access'] = "modules/CDev/WholesaleTrading/import_product_access.tpl";
        $this->pages['import_purchase_limit'] = "Import purchase limit";
        $this->pageTemplates['import_purchase_limit'] = "modules/CDev/WholesaleTrading/import_purchase_limit.tpl";
    }
