...
class ExportCatalog extends \XLite\Controller\Admin\ExportCatalog implements \XLite\Base\IDecorator
{
    public function __construct(array $params)
    {
        ...
        $this->pageTemplates['export_wholesale_pricing'] = "modules/CDev/WholesaleTrading/export_wholesale_pricing.tpl";
        $this->pages['export_product_access'] = "Export product access";
        $this->pageTemplates['export_product_access'] = "modules/CDev/WholesaleTrading/export_product_access.tpl";
        $this->pages['export_purchase_limit'] = "Export purchase limit";
        $this->pageTemplates['export_purchase_limit'] = "modules/CDev/WholesaleTrading/export_purchase_limit.tpl";
    }
