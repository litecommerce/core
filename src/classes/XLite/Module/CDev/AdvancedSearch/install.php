...
EOT;
        $replace_str = <<<EOT
<widget module="AdvancedSearch" mode="" target="advanced_search" head="Search for products" template="common/dialog.tpl" body="modules/CDev/AdvancedSearch/advanced_search.tpl">
...
EOT;
    $replace_str = <<<EOT
<widget module="Promotion" template="modules/CDev/Promotion/location.tpl">
<widget module="AdvancedSearch" template="modules/CDev/AdvancedSearch/location.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
else
