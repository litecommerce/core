...
namespace XLite\Module\CDev\GoogleCheckout\View;
...
class ButtonAltCheckout extends \XLite\View\Button
{
     ...
     * Service object
     * 
     * @var    \XLite\Module\CDev\GoogleCheckout\View\GoogleAltCheckout
     * @access protected
     * @see    ____var_see____
     * @since  3.0.0
     */
    ...
    {
        return 'modules/CDev/GoogleCheckout/shopping_cart/button.tpl';
    }
     ...
     * Get service object 
     * 
     * @return \XLite\Module\CDev\GoogleCheckout\View\GoogleAltCheckout
     * @access public
     * @see    ____func_see____
     * @since  3.0.0
     */
    public function getGacObject()
    {
        if (is_null($this->gacObject)) {
            $this->gacObject = new \XLite\Module\CDev\GoogleCheckout\View\GoogleAltCheckout();
