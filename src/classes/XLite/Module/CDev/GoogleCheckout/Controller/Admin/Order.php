...
namespace XLite\Module\CDev\GoogleCheckout\Controller\Admin;
...
class Order extends \XLite\Controller\Admin\Order implements \XLite\Base\IDecorator
{
    ...
    function init()
    {
        if ($this->xlite->get('AOMEnabled')) {
            ...
            $this->pageTemplates['google_checkout'] = "modules/CDev/GoogleCheckout/order.tpl";
        } else {
            $this->pages = array(
            ...
            $this->pageTemplates = array(
                    ...
                    "google_checkout"	=> "modules/CDev/GoogleCheckout/order.tpl"
                );
        }
