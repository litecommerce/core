...
EOT;
    $replace_str = <<<EOT
<widget module="SecureTrading" template="modules/CDev/SecureTrading/checkout.tpl" visible="{cart.paymentMethod.formTemplate=#modules/SecureTrading/checkout.tpl#}">
<!-- PAYMENT METHOD FORM -->
EOT;
