...
namespace XLite\Module\CDev\SecureTrading;
...
abstract class Main extends \XLite\Module\AModule
{
    ...
    {
        return '<b>Note:</b> Please visit the <a href="admin.php?target=payment_method&payment_method=securetrading">Payment method setup page</a> in order to setup your SecureTrading merchant account';
    }
}
