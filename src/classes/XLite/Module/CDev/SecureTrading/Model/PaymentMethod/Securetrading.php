...
namespace XLite\Module\CDev\SecureTrading\Model\PaymentMethod;
...
class Securetrading extends \XLite\Model\PaymentMethod\CreditCard
{
    ...
    public $configurationTemplate = "modules/CDev/SecureTrading/config.tpl";
    public $processorName = "SecureTrading";
    public $formTemplate = "modules/CDev/SecureTrading/checkout.tpl";
