 ...
 */
class Pages extends \XLite\View\TopMenu\Node
{
    /**
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams[static::PARAM_TITLE]->setValue(static::t('Pages'));
        $this->widgetParams[static::PARAM_TARGET]->setValue('pages');
    }
}
