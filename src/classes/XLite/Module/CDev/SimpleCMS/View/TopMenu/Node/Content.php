...
namespace XLite\Module\CDev\SimpleCMS\View\TopMenu\Node;

/**
 * Content
 *
 * @ListChild (list="menus", weight="550", zone="admin")
 */
class Content extends \XLite\View\TopMenu\Node
{
    /**
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams[static::PARAM_TARGET]->setValue(
            \XLite\Core\Auth::getInstance()->isPermissionAllowed('manage custom pages') ? 'pages' : 'menus'
        );
    }
}
