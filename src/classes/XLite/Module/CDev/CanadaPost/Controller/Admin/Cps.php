...
namespace XLite\Module\CDev\CanadaPost\Controller\Admin;
 ...
 * @since   3.0.0
 */
class Cps extends \XLite\Controller\Admin\AAdmin
{
    ...
    public function __construct(array $params)  
    {
        ...
        $cps = new \XLite\Module\CDev\CanadaPost\Model\Shipping\Cps();
    ...
    function action_test()  
    {
        ...
        $this->cps = new \XLite\Module\CDev\CanadaPost\Model\Shipping\Cps();
