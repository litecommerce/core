...
class Product extends \XLite\Controller\Admin\Product implements \XLite\Base\IDecorator
{
    ...
    function handleRequest()
    {
        ...
        if ($product->get('ups_packaging') > 0) {
            ...
            $item = new \XLite\Module\CDev\UPSOnlineTools\Model\PackItem();
    ...
    public function __construct(array $params)
    {
        ...
        $this->pageTemplates['ups_settings'] = "modules/CDev/UPSOnlineTools/product.tpl";
    }
    ...
    function action_settings_update()
    {
        ...
        foreach ($fields as $field) {
            $properties[$field] = max(\XLite\Module\CDev\UPSOnlineTools\Model\PackItem::MIN_DIM_SIZE, $this->get($field));
        }
    ...
    {
        $ups = new \XLite\Module\CDev\UPSOnlineTools\Model\Shipping\Ups();
