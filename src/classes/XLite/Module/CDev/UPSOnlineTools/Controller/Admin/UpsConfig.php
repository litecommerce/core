...
class UpsConfig extends \XLite\Controller\Admin\AAdmin
{
     ...
     * UPS shipping method
     * 
     * @var    \XLite\Module\CDev\UPSOnLineTools\Model\Shipping\Ups
     * @access protected
     * @see    ____var_see____
     * @since  3.0.0
     */
    ...
    protected function doActionUpdate() 
    {
        ...
        foreach ($fields as $key) {
            if (isset($settings[$key])) {
                $settings[$key] = max(\XLite\Module\CDev\UPSOnlineTools\Model\PackItem::MIN_DIM_SIZE, $settings[$key]);
            }
        }
    ...
    {
        return \XLite\Module\CDev\UPSOnlineTools\Main::isGDLibValid();
    }
