...
function UPSOnlineTools_optimize_subspaces(&$subspaces, $optimize_method)
{
    ...
    if ($optimize_method & \XLite\Module\CDev\UPSOnlineTools\Model\Container::OPTIMIZE_DIVIDE_HOR) {
        $methods[] = "divide_subspaces_h";
    }

    if ($optimize_method & \XLite\Module\CDev\UPSOnlineTools\Model\Container::OPTIMIZE_DIVIDE_VER) {
        $methods[] = "divide_subspaces_v";
    }

    if ($optimize_method & \XLite\Module\CDev\UPSOnlineTools\Model\Container::OPTIMIZE_REVERSE) {
        $methods = array_reverse($methods);
    }

    $is_divided = false;
    foreach ($methods as $method) {
        if ($is_divided && ($optimize_method & \XLite\Module\CDev\UPSOnlineTools\Model\Container::OPTIMIZE_COMBINE_INTERMEDIATE)) {
    ...
    if ($optimize_method & \XLite\Module\CDev\UPSOnlineTools\Model\Container::OPTIMIZE_COMBINE) {
        UPSOnlineTools_combine_subspaces($subspaces);
    }
        ...
        for ($i = 0; $i < $count - 1; $i++) {
            ...
            for ($j = $i + 1; $j < $count; $j++) {
                ...
                if ((($a->left + $a->width) == $b->left) ||
                    ...
                    // object "a"
                    if ($b_v0 - $a_v0 > 0) {
                        $sub_a0 = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
                    ...
                    if (min($b_v1, $a_v1) - max($b_v0, $a_v0) > 0) {
                        $sub_a1 = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
                    ...
                    if ($a_v1 - $b_v1 > 0) {
                        $sub_a2 = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
                    ...
                    // object "b"
                    if ($a_v0 - $b_v0 > 0) {
                        $sub_b0 = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
                    ...
                    if (min($a_v1, $b_v1) - max($a_v0, $b_v0) > 0) {
                        $sub_b1 = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
                    ...
                    if ($b_v1 - $a_v1 > 0) {
                        $sub_b2 = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
        ...
        for ($i = 0; $i < $count - 1; $i++) {
            ...
            for ($j = $i + 1; $j < $count; $j++) {
                ...
                if ((($a->left + $a->width) == $b->left ||
                    ...
                    $subspace = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
...
function UPSOnlineTools_solve_binpack($width, $length, $height, $weight, &$items)
{
    ...
    if (count($items) > PACKING_SIMPLIFY_AFTER) {
        $presets = array(\XLite\Module\CDev\UPSOnlineTools\Model\Container::OPTIMIZE_PRESET_3);
    } else {
        $presets = array(\XLite\Module\CDev\UPSOnlineTools\Model\Container::OPTIMIZE_PRESET_1, \XLite\Module\UPSOnlineTools\Model\Container::OPTIMIZE_PRESET_2, \XLite\Module\UPSOnlineTools\Model\Container::OPTIMIZE_PRESET_3, \XLite\Module\UPSOnlineTools\Model\Container::OPTIMIZE_PRESET_4, \XLite\Module\UPSOnlineTools\Model\Container::OPTIMIZE_PRESET_5, \XLite\Module\UPSOnlineTools\Model\Container::OPTIMIZE_PRESET_6);
    }
...
function UPSOnlineTools_placeBox($_this, $_width, $_length)
{
    ...
    $sub = array(
        0 => new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace(),
        1 => new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace(),
    );

    $a = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
    $a->init($_this->width, ($_this->length - $_length), $_this->left, ($_this->top + $_length));

    $b = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
...
function UPSOnlineTools_progressive_solve($_this, &$items)
{
    ...
    do {
        ...
        do {
            ...
            $level->optimizeSubspaces(\XLite\Module\CDev\UPSOnlineTools\Model\Container::OPTIMIZE_PRESET_6);
...
//        $_this->threshold2 = 0;
        ...
        if ($place_item) {
            ...
            $used_space = new \XLite\Module\CDev\UPSOnlineTools\Model\Subspace();
            ...
            $cont_item = new \XLite\Module\CDev\UPSOnlineTools\Model\ContainerItem();
...
function UPSOnlineTools_getNextLevel($_this, $overlaped=true)
{
    if ($_this->getLevelsCount() <= 0) {
        $level = new \XLite\Module\CDev\UPSOnlineTools\Model\ContainerLevel();
...
{
    if (!isset($container['levels']) || count($container['levels']) <= 0 || $_this->xlite->config->CDev->UPSOnlineTools->display_gdlib) {
        return;
    }
    ...
    foreach ($container['levels'] as $level) {
        if ($_this->xlite->config->CDev->UPSOnlineTools->level_display_method == 1) {
            // proportional
