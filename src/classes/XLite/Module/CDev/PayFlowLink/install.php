...
start_patching('PayFlowLink');

$location = "skins/default/en/checkout/details_dialog.tpl";
    
if (!is_template_patched($location, "PayFlowLink"))
{
    $find_str = <<<EOT
<!-- PAYMENT METHOD FORM -->
EOT;
    $replace_str = <<<EOT
<widget module="PayFlowLink" template="modules/CDev/PayFlowLink/checkout.tpl" visible="{cart.paymentMethod.formTemplate=#modules/PayFlowLink/checkout.tpl#}">
<!-- PAYMENT METHOD FORM -->
EOT;
