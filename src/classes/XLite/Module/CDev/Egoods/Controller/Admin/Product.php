...
class Product extends \XLite\Controller\Admin\Product implements \XLite\Base\IDecorator
{
    public function __construct(array $params) 
    {
        ...
        $this->pageTemplates['downloadable_files'] = "modules/CDev/Egoods/downloadable_files.tpl";
        $this->pages['pin_codes'] = "PIN codes";
        $this->pageTemplates['pin_codes'] = "modules/CDev/Egoods/pin_codes.tpl";
    ...
    function action_add_egood() 
    {
        ...
        (
    		...
    		$df = new \XLite\Module\CDev\Egoods\Model\DownloadableFile();
    ...
    {
        $df = new \XLite\Module\CDev\Egoods\Model\DownloadableFile($_POST['file_id']);
    ...
    function action_delete_egood() 
    {
        ...
        @unlink($df->get('data'));
        $df->delete();
        $link = new \XLite\Module\CDev\Egoods\Model\DownloadableLink();
    ...
    {
        $dl = new \XLite\Module\CDev\Egoods\Model\DownloadableLink($_POST['new_acc']);
    ...
    function action_delete_links() 
    {
        ...
        foreach ($_POST['selected_links'] as $access_key) {
            $dl = new \XLite\Module\CDev\Egoods\Model\DownloadableLink();
    ...
    function action_delete_pin_codes() 
    {
        ...
        foreach ($_POST['selected_pins'] as $pin_id) {
            $p = new \XLite\Module\CDev\Egoods\Model\PinCode($pin_id);
            $p->delete();
        }
    }
    ...
    function getPinCodes() 
    {
        if (!isset($this->pin_codes)) {
            $p = new \XLite\Module\CDev\Egoods\Model\PinCode();
    ...
    {
        $pin_settings = new \XLite\Module\CDev\Egoods\Model\PinSettings();
        $action = "";
