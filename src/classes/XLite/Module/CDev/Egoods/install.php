...
if (!is_template_patched($location, "Egoods"))
{
    $find_str = <<<EOT
<!-- [/center] -->
EOT;
    $replace_str = <<<EOT
<widget module="Egoods" template="modules/CDev/Egoods/main.tpl">
<!-- [/center] --> 
EOT;
...
{
    $find_str = <<<EOT
<widget module="ProductOptions" template="modules/CDev/ProductOptions/invoice_options.tpl" visible="{item.hasOptions()}">
EOT;
    $replace_str = <<<EOT
<widget module="ProductOptions" template="modules/CDev/ProductOptions/invoice_options.tpl" visible="{item.hasOptions()}">
<widget module="Egoods" template="modules/CDev/Egoods/invoice.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
else
...
{
    $find_str = <<<EOT
<widget module="ProductOptions" template="modules/CDev/ProductOptions/invoice_options.tpl">
EOT;
    $replace_str = <<<EOT
<widget module="ProductOptions" template="modules/CDev/ProductOptions/invoice_options.tpl">
<widget module="Egoods" template="modules/CDev/Egoods/invoice.tpl">
...
<widget module="Egoods" template="modules/CDev/Egoods/location.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
else
