...
class CustomerNotifications extends \XLite\Controller\Admin\AAdmin
{
     ...
     * getAllParams 
     * 
     * @param mixed $exeptions ____param_comment____ OPTIONAL
     *  
     * @return void
     * @access public
     * @see    ____func_see____
     ...
     * @param mixed $udecode ____param_comment____ OPTIONAL
     *  
     * @return boolean 
     * @access protected
     * @see    ____func_see____
     ...
     * @param mixed $name       ____param_comment____
     * @param mixed $value      ____param_comment____
     * @param mixed $from_array ____param_comment____ OPTIONAL
     *  
     * @return boolean 
     * @access protected
     * @see    ____func_see____
    ...
    protected function getNotifications()
    {
        if (is_null($this->notifications)) {
            $cntfs = new \XLite\Module\CDev\ProductAdviser\Model\Notification();
