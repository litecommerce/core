 ...
 * @since   3.0.0
 */
class NotifyForm extends \XLite\View\AView
{
    /**
    ...
    {
        return 'modules/CDev/ProductAdviser/OutOfStock/notify_form.tpl';
    }
    ...
    public function getJSFiles()
    {
        ...
        $list[] = 'modules/CDev/ProductAdviser/OutOfStock/notify_form.js';
