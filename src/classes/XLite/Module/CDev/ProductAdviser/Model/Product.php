...
/**
 * \XLite\Module\CDev\ProductAdviser\Model\Product
 * 
 * @package XLite
...
class Product extends \XLite\Model\Product implements \XLite\Base\IDecorator
{
    ...
    public function getProductsAlsoBuy()
    {
        if (!isset($this->productsAlsoBuy)) {
            ...
            $productId = $this->get('product_id');
            $pabObj = new \XLite\Module\CDev\ProductAdviser\Model\ProductAlsoBuy();
    ...
    public function create()
    {
    	...
    	if ($this->config->ProductAdviser->period_new_arrivals > 0) {
        	...
        	$statistic = new \XLite\Module\CDev\ProductAdviser\Model\ProductNewArrivals();
    ...
    public function delete()
    {
        ...
        foreach ($linked as $objName) {
            $objName = '\XLite\Module\CDev\ProductAdviser\Model\\' . $objName;
    		$object = new $objName();
