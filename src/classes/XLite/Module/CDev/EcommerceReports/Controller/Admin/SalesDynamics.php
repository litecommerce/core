 ...
 * @since   3.0.0
 */
class SalesDynamics extends \XLite\Module\CDev\EcommerceReports\Controller\Admin\EcommerceReports
{
    ...
    function exportSales() 
    {
        ...
        $w->component = $this;
        $w->set('template', "modules/CDev/EcommerceReports/export_xls.tpl");
