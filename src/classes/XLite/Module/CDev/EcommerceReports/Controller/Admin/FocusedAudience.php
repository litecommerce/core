 ...
 * @since   3.0.0
 */
class FocusedAudience extends \XLite\Module\CDev\EcommerceReports\Controller\Admin\EcommerceReports
{
    public $crlf = "\r\n";
    ...
    function export_profiles() 
    {
        ...
        $w->component = $this;
        $w->set('template', "modules/CDev/EcommerceReports/export_csv.tpl");
