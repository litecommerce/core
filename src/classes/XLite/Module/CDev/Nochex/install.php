...
start_patching('Nochex');

// patching skins/default/en/checkout/credit_card.tpl
$location = "skins/default/en/checkout/details_dialog.tpl";
if (!is_template_patched($location, "Nochex"))
{
    $find_str = <<<EOT
<!-- PAYMENT METHOD FORM -->
EOT;
    $replace_str = <<<EOT
<widget module="Nochex" template="modules/CDev/Nochex/checkout.tpl" visible="{cart.paymentMethod.formTemplate=#modules/Nochex/checkout.tpl#}">
<!-- PAYMENT METHOD FORM -->
EOT;
