...
namespace XLite\Module\CDev\Nochex\Model\PaymentMethod;
...
{
    public $configurationTemplate = "modules/CDev/Nochex/config.tpl";
    public $formTemplate = "modules/CDev/Nochex/checkout.tpl";
