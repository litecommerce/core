...
namespace XLite\Module\CDev\Nochex;
...
abstract class Main extends \XLite\Module\AModule
{
    ...
    {
        return '<b>Note:</b> Please visit the <a href="admin.php?target=payment_method&payment_method=nochex">Payment method setup page</a> in order to configure Nochex module.';
    }
}
