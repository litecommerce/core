...
namespace XLite\Module\CDev\ePDQ\Model\PaymentMethod;
...
{
    public $configurationTemplate = "modules/CDev/ePDQ/config.tpl";
    public $formTemplate = "modules/CDev/ePDQ/checkout.tpl";
