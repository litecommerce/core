...
if (!is_template_patched($location, "modules/CDev/Promotion/order_offers.tpl"))
{
    $find_str = <<<EOT
...
EOT;
    ...
    <widget module=Promotion template="modules/CDev/Promotion/order_offers.tpl">
</table>
EOT;
...
$replace_str = <<<EOT
        <widget module="Promotion" template="modules/CDev/Promotion/invoice.tpl">
        <widget module="GiftCertificates" template="modules/CDev/GiftCertificates/invoice.tpl">
EOT;
...
if (!is_template_patched($location, "modules/CDev/Promotion/main.tpl"))
{
    $find_str = <<<EOT
<widget module="Promotion" target="DiscountCoupons" template="common/dialog.tpl" body="modules/CDev/Promotion/coupons.tpl" head="Discount coupons">
EOT;
    $replace_str = <<<EOT
<widget module="Promotion" target="DiscountCoupons" template="common/dialog.tpl" body="modules/CDev/Promotion/coupons.tpl" head="Discount coupons">
<widget module="Promotion" template="modules/CDev/Promotion/main.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
else
...
{
    $find_str = <<<EOT
<widget module="Promotion" target="checkout" mode="bonusList" template="common/dialog.tpl" body="modules/CDev/Promotion/bonus_list.tpl" head="You have earned bonus">
EOT;
    $replace_str = <<<EOT
<widget module="Promotion" target="checkout" mode="bonusList" template="common/dialog.tpl" body="modules/CDev/Promotion/bonus_list.tpl" head="You qualify for a special offer">
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
else
...
$find_str = <<<EOT
            <widget module="Promotion" template="modules/CDev/Promotion/print_invoice_label.tpl">
...
$replace_str = <<<EOT
            <widget module="Promotion" template="modules/CDev/Promotion/print_invoice_label.tpl">
            <widget module="GiftCertificates" template="modules/CDev/GiftCertificates/print_invoice_label.tpl">
EOT;
...
// patching skins/default/en/common/print_invoice.tpl
$find_str = <<<EOT
            <widget module="Promotion" template="modules/CDev/Promotion/print_invoice_total.tpl">
                <span FOREACH="order.getDisplayTaxes(),tax_name,tax">
EOT;
if (is_template_patched($location, $find_str)) {
    $replace_str = <<<EOT
