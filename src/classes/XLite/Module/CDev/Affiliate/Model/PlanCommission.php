...
class PlanCommission extends \XLite\Model\AModel
{
    ...
    {
        $bc = new \XLite\Module\CDev\Affiliate\Model\PlanCommission();
    ...
    {
        $pc = new \XLite\Module\CDev\Affiliate\Model\PlanCommission();
    ...
    {
        $cc = new \XLite\Module\CDev\Affiliate\Model\PlanCommission();
    ...
    function calculate($order)
    {
        $this->order = $order;
        $commissions = 0;
        $ap = new \XLite\Module\CDev\Affiliate\Model\AffiliatePlan($order->getComplex('partner.plan'));
        if ($ap->is('enabled')) {
