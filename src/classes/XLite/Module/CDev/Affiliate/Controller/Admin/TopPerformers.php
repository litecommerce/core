 ...
 * @since   3.0.0
 */
class TopPerformers extends \XLite\Module\CDev\Affiliate\Controller\Admin\PartnerStats
{
    function getPageTemplate()
    {
        return "modules/CDev/Affiliate/top_performers.tpl";
    }
    ...
    function getStats()
    {
        if (is_null($this->stats)) {
            $ss = new \XLite\Module\CDev\Affiliate\Model\BannerStats();
            $this->stats = array();
