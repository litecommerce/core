...
namespace XLite\Module\CDev\MultiCurrency\Controller\Admin;
...
class Currencies extends \XLite\Controller\Admin\AAdmin
{
    ...
    function action_update()  
    {
        foreach ($this->currencies as $currency_) {
            $currency = new \XLite\Module\CDev\MultiCurrency\Model\CurrencyCountries($currency_['currency_id']);
    ...
    function action_delete() 
    {
        if (isset($this->deleted)) {
            foreach ($this->deleted as $currency_id) {
                $currency = new \XLite\Module\CDev\MultiCurrency\Model\CurrencyCountries($currency_id);
                $currency->delete();
            }
        }
    }
