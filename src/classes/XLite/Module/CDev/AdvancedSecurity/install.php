...
EOT;
    $replace_str = <<<EOT
<widget target="order_list,order,advanced_security" module="AdvancedSecurity" template="modules/CDev/AdvancedSecurity/advanced_security.tpl">
<widget target="order_list" template="order/search.tpl">
EOT;
...
<widget module="AdvancedSecurity" template="modules/CDev/AdvancedSecurity/location.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
} else {
    already_patched($location);
...
<hr><br>
<widget module="AdvancedSecurity" template="modules/CDev/AdvancedSecurity/payment_methods_note.tpl">
