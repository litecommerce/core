...
if (!is_template_patched($location, "ChronoPay"))
{
    $find_str = <<<EOT
<!-- PAYMENT METHOD FORM -->
EOT;
    $replace_str = <<<EOT
<widget module="ChronoPay" template="modules/CDev/ChronoPay/checkout.tpl" visible="{cart.paymentMethod.formTemplate=#modules/ChronoPay/checkout.tpl#}">
<!-- PAYMENT METHOD FORM -->
EOT;
    patch_template($location, "ChronoPay", $find_str, $replace_str);
}
else
{
