...
namespace XLite\Module\CDev\ChronoPay\Model\PaymentMethod;
...
{
    public $configurationTemplate = "modules/CDev/ChronoPay/config.tpl";
    public $processorName = "ChronoPay";
    public $formTemplate ="modules/CDev/ChronoPay/checkout.tpl";
