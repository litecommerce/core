...
class Order extends \XLite\Model\Order implements \XLite\Base\IDecorator
{
     ...
     * 
     * @param \XLite\Module\CDev\InventoryTracking\Model\Inventory $inventory Item inventory
     ...
     * @since  3.0.0
     */
    protected function updateItemInventory(\XLite\Module\CDev\InventoryTracking\Model\Inventory $inventory, array $items)
    {
     ...
     * 
     * @param boolean                                        $status    Decrease inventory flag
     * @param \XLite\Module\CDev\InventoryTracking\Model\Inventory $inventory Inventory item
     * @param \XLite\Model\OrderItem                          $item      Order item
     *  
     * @return void
     * @access protected
     ...
     * @since  3.0.0
     */
    protected function changeItemInventory($status, \XLite\Module\CDev\InventoryTracking\Model\Inventory $inventory, \XLite\Model\OrderItem $item)
    {
        $amount = $status
