...
namespace XLite\Module\CDev\InventoryTracking\Controller\Admin;
...
class Product extends \XLite\Controller\Admin\Product implements \XLite\Base\IDecorator
{
    ...
    public function __construct(array $params)
    {
        ...
        $this->pageTemplates['inventory_tracking'] = "modules/CDev/InventoryTracking/product.tpl";
    }
    ...
    function getProductOptions()
    {
        ...
        $po = new \XLite\Module\CDev\ProductOptions\Model\ProductOption();
    ...
    {
        $i = new \XLite\Module\CDev\InventoryTracking\Model\Inventory($this->inventory_id);
        $i->delete();
