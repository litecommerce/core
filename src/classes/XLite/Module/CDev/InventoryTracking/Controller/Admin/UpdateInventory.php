...
class UpdateInventory extends \XLite\Controller\Admin\UpdateInventory implements \XLite\Base\IDecorator
{
    ...
    public function __construct(array $params)
    {
        ...
        $this->pageTemplates['amount'] = "modules/CDev/InventoryTracking/update_amount.tpl";
    }

    function handleRequestAmount()
    {
        $this->inventory = \XLite\Module\CDev\InventoryTracking\Model\Inventory::getInstance();
    }
