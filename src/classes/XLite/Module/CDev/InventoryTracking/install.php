...
EOT;
    $replace_str = <<<EOT
<!-- [center] -->
<widget module="InventoryTracking" target="cart" mode="exceeding" template="common/dialog.tpl" body="modules/CDev/InventoryTracking/exceeding.tpl" head="InventoryTracking Notification">
EOT;
...
EOT;
    $replace_str = <<<EOT
    <widget module="ProductAdviser" template="modules/CDev/ProductAdviser/product_search.tpl">
    <widget module="InventoryTracking" template="modules/CDev/InventoryTracking/product_search.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
else
...
EOT;
    $replace_str = <<<EOT
<widget module="InventoryTracking" template="modules/CDev/InventoryTracking/inventory_sku.tpl" ignoreErrors>
<tr>
    <td valign=top>Quantity in stock</td>
    <td valign=top> <input type="text" name="optdata[amount]" value="{ivt.amount}"></td>
</tr>
...
EOT;
    $replace_str = <<<EOT
<widget module="InventoryTracking" template="modules/CDev/InventoryTracking/inventory_sku.tpl" newInventory ignoreErrors>
<tr>
    <td colspan=2>Quantity in stock</td>
    <td><input type="text" name="amount" value="{inventory.amount}"></td>
</tr>
...
} // file_exists(skins/admin/en/modules/CDev/ProductOptions/inventory_tracking.tpl)
