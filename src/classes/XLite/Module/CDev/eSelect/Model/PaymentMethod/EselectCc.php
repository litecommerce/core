...
namespace XLite\Module\CDev\eSelect\Model\PaymentMethod;
 ...
 * @since   3.0.0
 */
class EselectCc extends \XLite\Model\PaymentMethod\CreditCard
{
    public $configurationTemplate = "modules/CDev/eSelect/config.tpl";
