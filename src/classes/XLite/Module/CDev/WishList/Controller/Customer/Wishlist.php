...
class Wishlist extends \XLite\Controller\Customer\ACustomer
{
     ...
     * getWishListProduct 
     * 
     * @return \XLite\Module\CDev\WishList\Model\WishListProduct
     * @access protected
     * @since  3.0.0
     */
    protected function getWishListProduct()
    {
        $product = new \XLite\Module\CDev\WishList\Model\WishListProduct();
     ...
     * prepareWishListItem 
     * 
     * @param \XLite\Module\CDev\WishList\Model\WishListProduct $product Item to prepare
     ...
     * @since  3.0.0
     */
    protected function prepareWishListItem(\XLite\Module\CDev\WishList\Model\WishListProduct $product, $status)
    {
    ...
    protected function doActionMove()
    {
        ...
        $wishlistProduct = new \XLite\Module\CDev\WishList\Model\WishListProduct();
     ...
     *
     * @param \XLite\Module\CDev\WishList\Model\WishListProduct $product Return product link for email
     *
     * @return string
     * @access public
     * @since  3.0.0
     */
    public function getWishListProductURL(\XLite\Module\CDev\WishList\Model\WishListProduct $product)
    {
