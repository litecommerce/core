...
class Wishlists extends \XLite\Controller\Admin\AAdmin
{
    ...
    protected function doActionSearch()
    {
        ...
        if (!is_array($searchParams)) {
            $searchParams = \XLite\Module\CDev\WishList\Model\WishList::getDefaultSearchConditions();
        }
    ...
    public function getWishlists()
    {
        if (is_null($this->wishlists)) {
            ...
            $wishlist = new \XLite\Module\CDev\WishList\Model\WishList();
    ...
    protected function doActionDelete()
    {
        if (isset(\XLite\Core\Request::getInstance()->wishlistIds)) {
            ...
            foreach ($wishlists as $id) {
                ...
                $wishlist = new \XLite\Module\CDev\WishList\Model\WishList($id);
