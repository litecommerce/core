...
namespace XLite\Module\CDev\WishList\Controller\Admin;
...
class Wishlist extends \XLite\Controller\Admin\AAdmin
{
    ...
    protected function getRegularTemplate()
    {
        if ('print' == \XLite\Core\Request::getInstance()->mode) {
            $return = 'modules/CDev/WishList/wishlist.tpl';
     ...
     * getWishlist 
     * 
     * @return \XLite\Module\CDev\WishList\Model\WishList
     * @access public
     * @see    ____func_see____
     * @since  3.0.0
     */
    public function getWishlist()
    {
        if (is_null($this->wishlist)) {
            $this->wishlist = new \XLite\Module\CDev\WishList\Model\WishList(\XLite\Core\Request::getInstance()->wishlist_id);
        }
    ...
    {
        $wishlist = new \XLite\Module\CDev\WishList\Model\WishList(\XLite\Core\Request::getInstance()->wishlist_id);
