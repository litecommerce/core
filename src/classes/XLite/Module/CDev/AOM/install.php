...
EOT;
    $replace_str = <<<EOT
<a href="admin.php?target=states">States</a><br>
<widget module="AOM" template="modules/CDev/AOM/menu.tpl">
EOT;
...
<widget module="AOM" template="modules/CDev/AOM/location.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
else
...
EOT;
    $replace_str = <<<EOT
<a href="admin.php?target=order_list">Orders</a><br>
<widget module="AOM" template="modules/CDev/AOM/management.tpl">
EOT;
    patch_template($location, null, $find_str, $replace_str);
}
else
