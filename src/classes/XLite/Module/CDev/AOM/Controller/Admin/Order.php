...
class Order extends \XLite\Controller\Admin\Order implements \XLite\Base\IDecorator
{
    ...
    (
        "order_info"	=> "modules/CDev/AOM/order.tpl",
        "order_history"	=> "modules/CDev/AOM/order_history.tpl",
        "order_edit"	=> "modules/CDev/AOM/order_edit.tpl",		
        "order_preview" => "modules/CDev/AOM/order_edit/preview.tpl"
    );
    ...
    {
        if ($this->mode == "show" || $this->mode == "search") return "modules/CDev/AOM/add_products.tpl";
        if ($this->mode == "show_users" || $this->mode == "search_users") return "modules/CDev/AOM/add_users.tpl";
...
// actions 
    ...
    function updateOrderAsCart($order)
    {
        ...
        if ($this->xlite->get('PromotionEnabled')) {
            ...
            if ($cart->_getAppliedDiscount() != $orig_properties['discount']) {
                ...
                $cart->DC = new \XLite\Module\CDev\Promotion\Model\DiscountCoupon();
    ...
    function action_add_gc()  
    {
        ...
        $giftCertificate = new \XLite\Module\CDev\GiftCertificates\Model\GiftCertificate($this->get('add_gcid'));
        $item = new \XLite\Model\OrderItem();
    ...
    {
        $cloneOrder = $this->get('cloneOrder');
        $gc = new \XLite\Module\CDev\GiftCertificates\Model\GiftCertificate($this->get('add_gcid'));
 	...
 	function action_add_dc()  
    {
        ...
        $dc = new \XLite\Module\CDev\Promotion\Model\DiscountCoupon($this->add_dc);
