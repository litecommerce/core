...
/**
 * Shipping cost VAT label (cart and checkout page)
 * 
 * @see   ____class_see____
 * @since 1.0.8
 * @ListChild (list="checkout.review.selected.items.modifier", weight="100")
 * @ListChild (list="checkout.review.inactive.items.modifier", weight="100")
 * @ListChild (list="cart.panel.totals.modifier", weight="100")
 */
class CartShippingCostVAT extends \XLite\View\AView
{
    /**
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += array(
            ...
            self::PARAM_CART      => new \XLite\Model\WidgetParam\Object('Order', null, false, '\\XLite\\Model\\Cart'),
        );
    }
    ...
    {
        return 'modules/CDev/VAT/cart_shipping_cost_vat.tpl';
    }
