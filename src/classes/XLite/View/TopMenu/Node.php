...
class Node extends \XLite\View\TopMenu
{
    ...
    protected function getLink()
    {
        ...
        } elseif ('' !== $this->getParam(static::PARAM_TARGET)) {
            $link = $this->buildURL($this->getParam(static::PARAM_TARGET), '', $this->getParam(static::PARAM_EXTRA));
        }
    ...
    protected function isCurrentPageLink()
    {
        return '' !== $this->getParam(static::PARAM_TARGET)
            && in_array(
                ...
                $this->getRelatedTargets($this->getParam(static::PARAM_TARGET))
            );
    }
