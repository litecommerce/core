 ...
 * @since 1.0.15
 *
 * @Entity (repositoryClass="\XLite\Model\Repo\Attribute\Value\Selector")
...
class Selector extends \XLite\Model\Attribute\Value
{
    ...
    /**
     * Objects collection to array
     *
     * @return array
     * @see    ____func_see____
     * @since  1.0.16
     */
    public function getChoicesAsPlainArray()
    {
        $result = array();

        foreach ($this->getChoices() as $choice) {
            $result[$choice->getId()] = $choice->getTitle();
        }
