...
*
* @package $Package$
* @version $Id: add_ip.php,v 1.2 2008/10/23 11:44:17 sheriff Exp $
*/
class Admin_Dialog_add_ip extends Dialog
{
    ...
    function init()
    {
        ...
        if($this->get("xlite.config.Security.admin_ip_protection") == "Y" && $this->get("mode") == "add" && $this->get("unique_key") != ""){
