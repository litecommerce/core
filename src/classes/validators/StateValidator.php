...
* @package Validator
* @access public
* @version $Id: StateValidator.php,v 1.11 2008/10/23 12:06:35 sheriff Exp $
*/
class CStateValidator extends CFieldValidator
{
    ...
    */
    function isValid()
    {
        ...
        if (isset($_POST[$field]) && isset($_POST[$countryField]) && $_POST[$field] != '') {
            $state = func_new("State",$_POST[$field]);
            $country = func_new("Country",$_POST[$countryField]);
