...
<TD style="padding-bottom: 2px;" IF="widget.img" class="CommonButtonBG" nowrap><a href="{widget.href:t}" target="{widget.hrefTarget:r}"><IMG src="images/{widget.img}" width="11" height="12" border="0" alt="{widget.label:h}"></a></TD>
