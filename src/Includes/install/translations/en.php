...
',
  ...
  'Checking critical dependencies' => 'Checking critical dependencies',
  'Checking non-critical dependencies' => 'Checking non-critical dependencies',
  ...
  'Hostname of your secure (HTTPS-enabled) web server (E.g.: secure.example.com). If omitted, it is assumed to be the same as the web server name.' => 'Hostname of your secure (HTTPS-enabled) web server (E.g.: secure.example.com). If omitted, it is assumed to be the same as the web server name.',
  ...
  'The name of the existing database to use (if the database does not exist on the server, you should create it to continue the installation).' => 'The name of the existing database to use (if the database does not exist on the server, you should create it to continue the installation).',
  ...
  'Yes' => 'Yes',
  'No' => 'No',
  'The Installation Wizard needs to know your web server and MySQL database details:' => 'The Installation Wizard needs to know your web server and MySQL database details:',
  'Push the "Next" button below to continue' => 'Push the "Next" button below to continue',
  ...
  'Push the "Next" button below to begin the installation' => 'Push the "Next" button below to begin the installation',
  ...
  'Wait until cache is built then push the \'Next\' button below to continue' => 'Wait until cache is built then push the \'Next\' button below to continue',
  'Push the \'Next\' button below to continue' => 'Push the \'Next\' button below to continue',
  'E-mail' => 'E-mail',
  'E-mail address of the store administrator' => 'E-mail address of the store administrator',
  'Password' => 'Password',
  'Confirm password' => 'Confirm password',
  'Creating administrator profile' => 'Creating administrator profile',
  ...
  'Checking PHP configuration' => 'Checking PHP configuration',
  'Preparing to install LiteCommerce database' => 'Preparing to install LiteCommerce database',
  ...
  'Next' => 'Next',
  'Status' => 'Status',
  'loopback_test_failed' => 'Installation cannot be continued<br>because the loopback test failed to host :host.</font>
	<br><br>
    If a firewall is installed on your system, please open access to :host.',
  'php_version_failed' => 'Dependency failed: Unsupported version of PHP (:phpver)</font>
    <br><br>
	Currently versions <b>5.3.0+</b> are supported. <BR><BR>
  ...
  'requirement_warning_text' => 'Your server configuration is not optimal; this can make your LiteCommerce-based store partially or even completely inoperative. Are you sure you want to continue the installation?',
  ...
  'ask_send_report_text' => 'Our testing has identified some problems. Do you want to send a report about your server configuration and test results, <br>
  ...
  'where_report_will_be_sent_text' => 'The report will be sent to our support HelpDesk. A regular support ticket will be created on your behalf. <br>
  ...
  'installation_start_text' => 'You are about to install LiteCommerce shopping system.<BR>This installation wizard will guide you through the installation process.',
  'Auth code' => 'Auth code',
  '(required for protection from unauthorized<BR> use of installation script)' => '(required for protection from unauthorized<BR> use of installation script)',
