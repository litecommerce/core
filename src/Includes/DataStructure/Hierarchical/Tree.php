 ...
 * @since      3.0.0
 */
class Tree extends AHierarchical
{
    /**
     ...
     * @since  3.0.0
     */
    public function addBefore($key, \Includes\DataStructure\Node\ANode $node)
    {
    }
     ...
     * @since  3.0.0
     */
    public function addAfter($key, \Includes\DataStructure\Node\ANode $node)
    {
    }
}
