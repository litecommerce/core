...
REPLACE INTO xlite_profiles SET profile_id = 2, login = 'rnd_tester@rrf.ru', password = '084e0343a0486ff05530df6c705c8bb4', access_level = 0, order_id = 0, added = UNIX_TIMESTAMP(NOW()), first_login = UNIX_TIMESTAMP(NOW()), last_login = UNIX_TIMESTAMP(NOW()), status = 'E', cms_profile_id = 1, cms_name = '____DRUPAL____';
...
REPLACE INTO xlite_profiles SET profile_id = 3, login = 'rnd_tester@cdev.ru', password = 'eb0a191797624dd3a48fa681d3061212', access_level = 100, order_id = 1, added = UNIX_TIMESTAMP(NOW()), first_login = UNIX_TIMESTAMP(NOW()), last_login = UNIX_TIMESTAMP(NOW()), status = 'E', cms_profile_id = 1, cms_name = '____DRUPAL____';
...
REPLACE INTO xlite_profiles SET profile_id = 4, login = 'rnd_tester@cdev.ru', password = 'eb0a191797624dd3a48fa681d3061212', access_level = 100, order_id = 2, added = UNIX_TIMESTAMP(NOW()), first_login = UNIX_TIMESTAMP(NOW()), last_login = UNIX_TIMESTAMP(NOW()), status = 'E', cms_profile_id = 1, cms_name = '____DRUPAL____';
