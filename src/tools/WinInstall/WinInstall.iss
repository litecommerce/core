...
UninstallDisplayIcon={app}\litecommerce-2.1.SP2-trial.exe
OutputBaseFilename=LiteCommerce-2.1-trial

[Files]
Source: "litecommerce-2.1.SP2-trial.exe"; DestDir: "{app}"
Source: "cpanel.exe"; DestDir: "{app}"

[Icons]
Name: "{group}\LiteCommerce Installation Wizard"; Filename: "{app}\litecommerce-2.1.SP2-trial.exe"
...
[Run]
Filename: "{app}\litecommerce-2.1.SP2-trial.exe"; Description: "Continue remote install"; Flags: postinstall
