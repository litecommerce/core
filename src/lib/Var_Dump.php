...
// +----------------------------------------------------------------------+
//
// $Id: Var_Dump.php,v 1.1.1.1 2003/05/23 11:03:30 novik Exp $
                ...
                if (
                    ...
                    if (!empty($array[VAR_DUMP_ARRAY_VALUE])) {
                        $table .=
                            ' ('.
                            $this->_VarDumpDisplayFont2Start.
                            htmlspecialchars($array[VAR_DUMP_ARRAY_VALUE]).
                            $this->_VarDumpDisplayFont2End.')';
                    } elseif (is_integer($array[VAR_DUMP_ARRAY_VALUE]) and $array[VAR_DUMP_ARRAY_VALUE] == 0) {
                        $table .=
                            ' ('.
                            $this->_VarDumpDisplayFont2Start.
                            '0'.
