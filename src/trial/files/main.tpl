...
<widget target="category" class="CTabber" body="{pageTemplate}" switch="page" visible="{!mode=#delete#}">
</span>
<span IF="xlite.LayoutOrganizerEnabled">
<widget module="LayoutOrganizer" target="category" class="CTabber" body="{pageTemplate}" switch="page" visible="{!mode=#delete#}">
</span>
...
<widget target="settings" class="CTabber" body="general_settings.tpl" switch="page">
...
<widget target="product" class="CTabber" body="{pageTemplate}" switch="page">
...
<widget target="profile" mode="modify" class="CRegisterForm" template="common/dialog.tpl" head="Modify profile" body="profile/body.tpl" name="profileForm">
<widget target="profile" mode="register" class="CRegisterForm" template="common/dialog.tpl" head="Add new user" body="profile/body.tpl" name="registerForm">
...
<widget target="shipping_methods" class="CTabber" body="{pageTemplate}" switch="target">
<widget target="shipping_rates" class="CTabber" body="{pageTemplate}" switch="target">
...
<widget class="CTabber" target="taxes" body="{pageTemplate}" switch="page">
<widget class="CTabber" target="db" body="{pageTemplate}" switch="page">

<widget target="import_users" template="common/dialog.tpl" body="import_users.tpl" head="Import users">
<widget target="import_catalog" class="CTabber" body="{pageTemplate}" switch="page">
<widget target="export_catalog" class="CTabber" body="{pageTemplate}" switch="page">
<widget target="update_inventory" class="CTabber" body="{pageTemplate}" switch="page">

<widget target="memberships" template="common/dialog.tpl" body="memberships.tpl" head="Membership levels">
<widget target="template_editor" class="CTabber" body="{pageTemplate}" switch="editor">
...
<widget module="UPS" target="ups" class="CTabber" body="{pageTemplate}" switch="target">
<widget module="UPS" target="ups"  template="common/dialog.tpl" body="modules/UPS/test.tpl" head="UPS Live Test">
<widget module="USPS" target="usps" class="CTabber" body="{pageTemplate}" switch="target">
<widget module="USPS" target="usps"  template="common/dialog.tpl" body="modules/USPS/test.tpl" head="UPS Live Test">
<widget module="Intershipper" target="intershipper" class="CTabber" body="{pageTemplate}" switch="target">
