...
<tr>
	<td>Country:&nbsp;</td><td><widget class="CCountrySelect" field="country" value="{country}"></td>
</tr>
<tr>
	<td>State:&nbsp;</td><td><widget class="CStateSelect" field="state" value="{state}"></td>
</tr>
<tr>
...
<p>
<a href="javascript: window.close()">Close tax calculator</a><br>
