...
<TR IF="target=widget.active">
	...
	<TD style="padding-bottom: 2px;" width="100%" class="TabSelectedBG" nowrap align="center"><A class="TopTabLink" href="{widget.href}"><FONT class="SelectedTab">{widget.label:h}</FONT></A></TD>
...
<TR IF="!target=widget.active">
	...
	<TD style="padding-bottom: 2px;" width="100%" class="TabNormalBG" nowrap align="center"><A class="TopTabLink" href="{widget.href}">{widget.label:h}</A></TD>
