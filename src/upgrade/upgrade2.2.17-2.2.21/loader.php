...
*
* $Id: loader.php,v 1.1 2006/08/23 11:26:30 sheriff Exp $
*/
...
if (func_lc_get_is_forbidden_version()) {
	$message = "<B>Unsupported version of PHP (" . phpversion() . ").<BR>Currently versions 4.1.0 - 4.4.X and 5.1.X are supported. <BR><BR> </B>";
	$message .= '</P><P align="justify">This version of LiteCommerce will work on any OS where PHP/MySQL meets minimum <a href="http://www.litecommerce.com/server_requirements.html">system requirements</a>.<br><br>You can find more information about LiteCommerce at <a href="http://www.litecommerce.com/faqs.html">http://www.litecommerce.com/faqs.html</a>.';
...
2. Unsupported version of PHP (currently versions 4.1.0 - 4.4.X and 5.1.X are supported)<br>
...
You can find more information about LiteCommerce at <a href="http://www.litecommerce.com/faqs.html">http://www.litecommerce.com/faqs.html</a>.';
	func_lc_show_splash($message);
	die;
}
?>