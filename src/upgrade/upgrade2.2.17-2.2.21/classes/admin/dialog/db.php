...
* @package Dialog
* @access public
* @version $Id: db.php,v 1.2 2006/08/23 10:13:00 sheriff Exp $
*
*/
class Admin_Dialog_db extends Admin_Dialog
{
    ...
    function handleRequest()
    {
        ...
        if ($this->action == "restore" && !isset($this->local_file) && !$this->checkUploadedFile()) {
    ...
    function action_restore()
    {
        ...
        { 
            ...
            move_uploaded_file($_FILES['userfile']['tmp_name'], $srcfile);
            $mode = "upload";
        }
        if ($this->get("mode") != "cp") {
            $this->startDump();
