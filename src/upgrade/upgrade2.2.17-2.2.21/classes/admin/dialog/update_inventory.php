...
* @package Dialog
* @access public
* @version $Id: update_inventory.php,v 1.2 2006/08/23 10:13:00 sheriff Exp $
*/
class Admin_Dialog_update_inventory extends Admin_dialog
{
    ...
    function import_pricing()
    {
        ...
        ?>
            <br>Product pricing imported successfully. <a href="admin.php?target=update_inventory">Click here to return to admin interface</a>
            <?php
		func_refresh_end();
		exit();
    }
