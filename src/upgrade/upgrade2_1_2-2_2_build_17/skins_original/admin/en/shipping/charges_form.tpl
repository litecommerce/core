<table border="0" width="100%">
	...
	<tbody FOREACH="shippingRates,k,rate">
		<tr>
			...
			<option FOREACH="shippings,shipping" value="{shipping.shipping_id}" selected="{isEqual(rate,shipping,#shipping_id#)}">{shipping.name}</option>
			</select>
			</td>
		...
		<tr>
			...
			<td>
				...
				<option FOREACH="xlite.factory.ShippingZone.findAll(),zone" value="{zone.shipping_zone}" selected="{isEqual(rate,zone,#shipping_zone#)}">{zone.name}</option>
				</select>
			</td>
            ...
            <td>Per lbs<br><input name="rate[{k}][per_lbs]" size="5" value="{rate.per_lbs}"></td>
		</tr>
	<tr>
		<td width="15"></td>
		<td></td>
	...
	<tr>
		...
		<option value="-1">All shipping methods</option>
		<option FOREACH="shippings,shipping" value="{shipping.shipping_id}">{shipping.name}</option>
		</select>
		</td>
	...
	<tr>
		...
		<td>
			...
			<option value="-1">All shipping zones</option>
			<option FOREACH="xlite.factory.ShippingZone.findAll(),zone" value="{zone.shipping_zone}">{zone.name}</option>
			</select>
		</td>
		...
		<td>Per lbs<br><input name="per_lbs" size="5" value="0.00"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td></td>
