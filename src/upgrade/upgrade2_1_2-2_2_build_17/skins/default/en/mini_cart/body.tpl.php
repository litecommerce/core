...
<tr IF="!cart.empty">
	<td>
		...
		<tr>
			<td colspan="2">
				<a href="cart.php?target=cart" class="SidebarItems"><img src="images/details.gif" width="13" height="13" border="0" align="absmiddle" alt=""> View cart</a>
				<br>
				<a href="cart.php?target=checkout" class="SidebarItems"><img src="images/go.gif" width="13" height="13" border="0" align="absmiddle" alt=""> Checkout</a><br>
			</td>
		</tr>
		</table>   
	</td>   
