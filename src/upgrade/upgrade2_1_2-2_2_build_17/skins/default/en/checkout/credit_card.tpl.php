...
<tr valign="middle">
    ...
    <td><input type="text" name="cc_info[cc_name]" value="{cart.details.cc_name:r}" size="32" maxlength="255"></td>
    <td colspan="2">&nbsp;</td>
</tr>
<tr valign="middle">
    <td align="right">Credit card number (no spaces or dashes)</td>
    <td><font class="Star">*</font></td>
    <td><input type="text" name="cc_info[cc_number]" value="{cart.details.cc_number:r}" size="32" maxlength="20"></td>
    <td colspan="2">&nbsp;</td>
</tr>
<tr valign="middle">
    <td align="right">Expiration date (MMYY)</td>
    <td><font class="Star">*</font></td>
    <td><input type="text" name="cc_info[cc_date]" value="{cart.details.cc_date:r}" size="4" maxlength="4"></td>
    <td colspan="2">&nbsp;</td>
</tr>
<tr valign="middle">
EOT;
...
EOT;
    ...
    <td valign="top"><font class="Star">*</font></td>
    <td valign="top"><input type="text" name="cc_info[cc_cvv2]" value="{cart.details.cc_cvv2:r}" size="4" maxlength="4"></td>
    <td colspan="2">&nbsp;</td>
</tr>
...
EOT;
    ...
    <td valign="top"><span id="cvv2_label"><font class="Star">*</font></span></td>
...
<widget module="CardinalCommerce" template="modules/CardinalCommerce/credit_card.tpl" visible="{dialog.SupportedByCardinalCommerce}">
</table>
