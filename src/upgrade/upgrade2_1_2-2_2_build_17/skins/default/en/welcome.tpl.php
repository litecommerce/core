<?php
    $find_str = <<<EOT
{* The front page *}
<h3 IF="!disable_head">Welcome to LiteCommerce</h3>

<p align="justify">This is a demo store with powerful LiteCommerce engine inside, based on PHP4 templates technology integrated with SQL database. If you order the LiteCommerce software, you will be able to setup a web store having all of the features this demo has. To test-drive this store, you can browse categories, add/remove products and view our help pages. You can even issue a test order. Feel free to test anything you like.
</p>
