...
* @package Dialog
* @access public
* @version $Id: template_editor.php,v 1.1 2006/07/11 06:38:15 sheriff Exp $
*
*/
class Admin_Dialog_template_editor extends Admin_Dialog
{
    ...
    */
    function &getBasicTemplates() // {{{
    {
        $zone = $this->get("zone");
        $pages = array(
            func_new("FileNode", "skins/$zone/en/news.tpl", null, SHOW_FULL_PATH), 
            func_new("FileNode", "skins/$zone/en/phones.tpl", null, SHOW_FULL_PATH), 
            func_new("FileNode", "skins/$zone/en/privacy_statement.tpl", null, SHOW_FULL_PATH), 
            func_new("FileNode", "skins/$zone/en/terms_conditions.tpl", null, SHOW_FULL_PATH), 
            func_new("FileNode", "skins/$zone/en/checkout/success_message.tpl", null, SHOW_FULL_PATH), 
        );

        if ( in_array($this->config->get("Skin.skin"), $this->get("welcome_page")) ) {
            $obj = func_new("FileNode", "skins/$zone/en/welcome.tpl", null, SHOW_FULL_PATH);
            array_unshift($pages, $obj);
        }
