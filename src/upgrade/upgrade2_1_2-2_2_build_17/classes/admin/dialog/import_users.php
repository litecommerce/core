...
* @package Dialog
* @access public
* @version $Id: import_users.php,v 1.1 2006/07/11 06:38:12 sheriff Exp $
*/
class Admin_Dialog_import_users extends Admin_Dialog
{
    ...
    function action_import()
    {
        ...
        $p->import($options);
?>
<br>Users are imported successfully. <a href="admin.php?target=import_users">Click here to return to admin interface</a>
<?php
    }
