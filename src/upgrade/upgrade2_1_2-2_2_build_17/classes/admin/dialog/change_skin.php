...
* @package Dialog
* @access public
* @version $Id: change_skin.php,v 1.1 2006/07/11 06:38:12 sheriff Exp $
*
*/
...
class Admin_Dialog_Change_Skin extends Admin_Dialog
{
	...
	function getSkins()
	{
        ...
        if ($dir = @opendir($this->_schemasRepository . "/templates")) {
        	$orig_files = array();
	...
	function checkBeforeChange()
	{
		...
		$log = $this->checkFiles($this->_schemasRepository."/templates/".$this->layout, "", $this->_templatesDirectory);
...
<TD valign=top>
	...
	<TR style="BACKGROUND-COLOR: #6685A5; COLOR:#FFFFFF; FONT-WEIGHT: bold; FONT-SIZE: 12px;" height="18">
		<TD align=left valign=top width=50%>&nbsp;&nbsp;&nbsp;LiteCommerce</TD>
		<TD align=right valign=top width=50%>Version: <?php echo $this->config->get("Version.version"); ?>&nbsp;&nbsp;&nbsp;</TD>
	</TR>
	</TABLE>
</TD>
</TR>
...
<H1>Installing skin: <?php echo $this->layout; ?></H1>
...
<?php
		...
		if ( $this->ignore_errors != "yes" ) {
			if ( !$this->CheckBeforeChange() ) {
				echo '<font color="red"><b>Note: The files listed above will remain unchanged.</b></font>';
				echo '&nbsp;&nbsp;<a href="admin.php?target=change_skin&action=update&layout='.$this->layout.'&ignore_errors=yes"><u>Continue anyway</u></a>';
				echo '<p><a href="'.$this->get("url").'"><u>Return to admin zone</u></a>';
				return;
			}
		}
    	...
    	$ck_res &= $this->copyFiles($this->_schemasRepository."/templates/".$this->layout, "", $this->_templatesDirectory);
...
<a href="<?php echo $this->get("url"); ?>"><u>Return to admin zone</u></a>
<?php
