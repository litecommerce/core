...
* @package Dialog
* @access public
* @version $Id: image_edit.php,v 1.1 2006/07/11 06:38:12 sheriff Exp $
*
*/
...
class Admin_Dialog_Image_Edit extends Admin_Dialog
{
    ...
    function &getEditor()
    {
        ...
        if (!isset($this->editor)) {
            $this->editor =& func_new("ImageEditor", "skins/$zone/en/images.ini");
        }
        return $this->editor;
    }
    ...
    function action_change()
    {
        ...
        $editor->uploadImage($image_field_name, $this->current_image);
    }
}
