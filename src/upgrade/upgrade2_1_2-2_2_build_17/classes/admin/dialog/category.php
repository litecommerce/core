...
* @package Dialog
* @access public
* @version $Id: category.php,v 1.1 2006/07/11 06:38:03 sheriff Exp $
*
*/
class Admin_Dialog_category extends Admin_Dialog
{
    ...
    function getLocationPath()
    {
        ...
        if ($this->get("mode") == "add" && $this->get("parentCategory.category_id") != 0) {
            foreach ($this->get("parentCategory.path") as $category) {
                $result[$category->get("name")] = "admin.php?target=categories&category_id=" . $category->get("category_id");
            }
