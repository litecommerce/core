...
*
* @package Kernel
* @version $Id: Category.php,v 1.1 2006/07/11 06:38:21 sheriff Exp $
*/
    ...
    */
    ...
    function filter() // {{{
    {
        ...
        if ($result && !$this->xlite->is("adminZone")) {
            ...
            $c = $this;
            do { // check parent categories
                if (!$c->is("enabled") || trim($c->get("name")) == "") {
                    $result = false;
                    break;
                }
                if (!$this->_compareMembership($c->get("membership"), $membership)) {
                    $result = false;
                    break;
                }
                $c = $c->get("parentCategory");
            } while (!is_null($c));
        }
        return $result;
    } // }}}
    ...
    {
        return $categoryMembership == '%' || $categoryMembership == '_%' && $userMembership || $categoryMembership == $userMembership;
    } // }}}
