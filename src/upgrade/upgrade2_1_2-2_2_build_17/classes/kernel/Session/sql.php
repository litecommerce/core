...
* @package Kernel
* @access public
* @version $Id: sql.php,v 1.1 2006/07/11 06:38:27 sheriff Exp $
*/
...
/******************************* DB layer **********************************/
    ...
    */
    function create()
    {
        $sql = "REPLACE INTO $this->sql_table (id, expiry, data) VALUES ('".$this->getID()."', ".(time() + $this->getTtl()).", '".$this->getData()."')";
    ...
    */
    function update()
    {
        $sql = "UPDATE $this->sql_table SET expiry = ".(time() + $this->getTtl()).", data = '".$this->getData()."' WHERE id = '".$this->getID()."' AND expiry >= ".time();
        return $this->db->query($sql);
    }
