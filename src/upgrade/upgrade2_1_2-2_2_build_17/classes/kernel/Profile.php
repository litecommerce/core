...
* @package Kernel
* @access public
* @version $Id: Profile.php,v 1.1 2006/07/11 06:38:24 sheriff Exp $
*/
class Profile extends Base
{
    ...
    **/
    ...
    {
        return func_new("Country", $this->get("billing_country"));
    } // }}}
    function getShippingCountry() // {{{
    {
        return func_new("Country", $this->get("shipping_country"));
    } // }}}
    ...
    */
    ...
    function _convertState($value)
    {
    	...
    	if ($state->find("code='$value'") || $state->find("state='$value'")) {
