...
*
* @package Kernel
* @version $Id: Database.php,v 1.1 2006/07/11 06:38:21 sheriff Exp $
*/
class Database extends Object
{
    ...
    */
    ...
    {
        global $options;
        $this->options = array_merge($this->options, $options["database_details"]);
    } // }}}
	...
	function query($sql) // {{{
	{
        ...
        $profiler->setQueryTime($sql, getmicrotime() - $start);
        return $res;
	} // }}}
    ...
    */
    ...
    function backup($file, $verbose = false) // {{{
    {
        ...
        $this->_write($handle, "-- WARNING: Do not change this line <?php /*\n");
        ...
        is_null($handle) or fclose($handle) && chmod($file, 0666);
    } // }}}

    function restore($file) // {{{
    {
        echo "Please wait...<br>\n";
        query_upload($file, $this->db->connection, true);
