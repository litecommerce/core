...
* @package kernel
* @access public
* @version $Id: ImageEditor.php,v 1.1 2006/07/11 06:38:24 sheriff Exp $
*/
...
class ImageEditor extends Object
{
    ...
    function uploadImage($image_field, $image_name)
    {
        ...
        if (move_uploaded_file($_FILES[$image_field]['tmp_name'], $image_file_name) && !stristr(PHP_OS, "win")) {
            $real_img_name = realpath(".") . '/' . $image_file_name;
            @chmod($real_img_name, 0666);
        }    
    }
}
