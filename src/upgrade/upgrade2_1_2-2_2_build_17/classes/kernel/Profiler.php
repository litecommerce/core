...
* @package Kernel
* @access public
* @version $Id: Profiler.php,v 1.1 2006/07/11 06:38:27 sheriff Exp $
*/
class Profiler extends Object
{
    ...
    {
        $this->$timePoint = getmicrotime() - $this->start_time;
    }
...
<p align=left>
<table border=0>
<tr><td style="FONT-WEIGHT: bold;">DB</td><td><?php print $this->db_time; ?></td></tr>
<tr><td style="FONT-WEIGHT: bold;">CFG</td><td><?php print $this->cfg_time; ?></td></tr>
<tr><td style="FONT-WEIGHT: bold;">SESSION</td><td><?php print $this->ss_time; ?></td></tr>
<tr><td style="FONT-WEIGHT: bold;">MM</td><td><?php print $this->mm_time; ?></td></tr>
<tr><td style="FONT-WEIGHT: bold;">INIT TOTAL</td><td><?php print $this->init_time; ?></td></tr>
<tr><td colspan=2>&nbsp;</td></tr>
<tr><td style="FONT-WEIGHT: bold;">REQUEST</td><td><?php print $this->request_time; ?></td></tr>
<tr><td style="FONT-WEIGHT: bold;">RUN</td><td><?php print $this->run_time; ?></td></tr>
<tr><td colspan=2>&nbsp;</td></tr>
<tr><td style="FONT-WEIGHT: bold; COLOR: red ">TOTAL TIME</td><td><?php print $this->stop_time - $this->start_time; ?></td></tr>
<tr><td colspan=2>&nbsp;</td></tr>
...
<?php
    ...
    {
        return getmicrotime() - $this->displayTime;
    }
