...
* @package Kernel
* @access public
* @version $Id: Mailer.php,v 1.1 2006/07/11 06:38:24 sheriff Exp $
*/
class Mailer extends Component
{
    ...
    */
    ...
    {
        if (!($this->get("to") == '')) {
            if (!isset($this->mail) || !$this->mail->Send()) {
                $this->logger->log("Mail FAILED: ".(isset($this->mail) ? $this->mail->ErrorInfo : "unknown error"));
            }
		}
