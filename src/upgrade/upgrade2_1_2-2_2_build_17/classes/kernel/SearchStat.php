...
* @package kernel
* @access public
* @version $Id: SearchStat.php,v 1.1 2006/07/11 06:38:27 sheriff Exp $
*/
class SearchStat extends Base
{
    var $fields = array(
        "query" => "",
        "product_count" => "0",
        "count" => "0");
    var $alias = "search_stat";
    var $primaryKey = array("query");
    
    function add($query, $foundCount) {
        $this->set("query", strtolower($query));
