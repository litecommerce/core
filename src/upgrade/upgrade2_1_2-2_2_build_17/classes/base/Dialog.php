...
* @package Base
* @access public
* @version $Id: Dialog.php,v 1.1 2006/07/11 06:38:18 sheriff Exp $
*/
class Dialog extends Component
{
    ...
    */
    ...
    function isSecure()
    {
        // keep customer in HTTPS after login (dismiss annoying message)
        if (!$this->xlite->is("adminZone") && !is_null($this->get("feed")) && $this->get("feed") == "login") {
