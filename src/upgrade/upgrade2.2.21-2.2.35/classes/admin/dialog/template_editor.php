...
* @package Dialog
* @access public
* @version $Id: template_editor.php,v 1.4 2007/06/22 11:19:43 osipov Exp $
*
*/
    ...
    */
    function &getBasicTemplates() // {{{
    {
		...
		foreach ($templates as $name) {
			$pages[] = func_new("FileNode", "skins/$zone/$locale/".$name, null, SHOW_FULL_PATH);
		}
    ...
    function getShortcuts() // {{{
    {
        ...
        if ($zone == "mail") {
            $shortcuts = array(
                    func_new("FileNode","skins/mail/$locale/order_processed/body.tpl", null, SHOW_FULL_PATH), 
                    );
        } elseif ($zone == "admin") {
        } else {
            $shortcuts = array(
