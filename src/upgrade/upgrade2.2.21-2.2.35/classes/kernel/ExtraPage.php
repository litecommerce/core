...
* @package kernel
* @access public
* @version $Id: ExtraPage.php,v 1.3 2007/05/21 11:53:28 osipov Exp $
*/
class ExtraPage extends Object
{
    ...
    */
    function add()
    {
        ...
        $this->addLine($this->getPageLinkContent(), $this->menuTemplate);
    ...
    */
    function modify()
    {
        ...
        $this->replaceLine("/cart\\.php\\?page=$this->page\"/", $this->getPageLinkContent(), $this->menuTemplate);
