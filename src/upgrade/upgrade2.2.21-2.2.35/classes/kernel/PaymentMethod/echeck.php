...
* @package Kernel
* @access public
* @version $Id: echeck.php,v 1.3 2007/05/21 11:53:28 osipov Exp $
*/
class PaymentMethod_echeck extends PaymentMethod
{
    ...
    {
        // save CH details to order
        $cart->set("details", $this->ch_info);
    ...
    {
        return (isset($_POST["ch_info"]) ? $_POST["ch_info"] : '');
    }

    function handleRequest(&$cart)
    {
        $this->ch_info = $this->getPaymentInfo();
        $this->process($cart);
