...
<tr IF="exp_error">
    <td>&nbsp;</td>
    <td><table border="0"><tr><td><img src="skins/admin/images/code.gif" alt="[!]"></td><td>&nbsp;The {exp_error:h} variables are not defined, the tax rate cannot be calculated.</td></tr></table></td>
</tr>
</table>
<br>
{if:edit}
