...
<span IF="target=#profile#&mode=#register#">&nbsp;::&nbsp;<a href="admin.php?target=profile&action=register" class="NavigationPath">Add new user</a></span>
...
<widget module="FancyCategories" template="modules/FancyCategories/location.tpl">
