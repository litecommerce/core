...
We release LiteCommerce updates every 2-4 weeks. Please see the {LiteCommerce 3 changelog}[https://github.com/litecommerce/core/wiki/LiteCommerce-3-changelog] for information on new features and bug fixes.
