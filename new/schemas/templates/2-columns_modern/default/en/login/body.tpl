...
<tr>
    <td>
        <a href="javascript: document.login_form.submit()" class="SidebarItems"><input type="image" src="images/go.gif" width="13" height="13" border="0" align="middle"> Submit</a><br>
        <a href="cart.php?target=profile&amp;mode=register" class="SidebarItems"><img src="images/go.gif" width="13" height="13" border="0" align="middle" alt=""> Register</a>
    </td>
</tr>
</table>
</form>
