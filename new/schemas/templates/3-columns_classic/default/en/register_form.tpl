...
The form below allows you to create a profile which is necessary to place
orders. Do not forget that this information is essential to use our services
correctly. Fields marked with <font class="Star">*</font> are mandatory. 

<p IF="target=#checkout#" align=justify>If you already have an account, please <a href="cart.php?target=profile&mode=login&returnUrl={dialog.url:u}"><u>login from here</u></a>.</p>
...
<tr valign="middle">
    ...
    <td >
        ...
        <widget class="CSubmit" href="javascript: document.registration_form.submit()" font="FormButton">
        <br>
    </td>
</tr>
</table>
