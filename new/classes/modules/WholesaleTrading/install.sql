...
UPDATE xlite_wholesale_pricing SET membership='all' WHERE membership='%';
...
ALTER TABLE xlite_global_discount ADD membership varchar(255) NOT NULL default '';
UPDATE xlite_global_discount SET membership='all' WHERE membership='%';
