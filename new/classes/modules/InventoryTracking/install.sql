...
ALTER TABLE xlite_inventories ADD enabled int(1) NOT NULL default '0';
ALTER TABLE xlite_inventories ADD order_by int(11) NOT NULL default '0';
ALTER TABLE xlite_inventories ADD inventory_sku varchar(32) NOT NULL default '';
...
CREATE INDEX order_by ON xlite_inventories (order_by);
