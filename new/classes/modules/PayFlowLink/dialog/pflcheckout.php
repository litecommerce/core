...
/**
* Dialog_pflcheckout description.
*
* @package Module_PayFlowLink
* @access public
*/

class Dialog_pflcheckout extends Dialog_checkout
{
...
<FORM name="frm" action="<?php echo $this->cart->get("paymentMethod.params.gateway_url"); ?>" method="POST">
