...
<input type="hidden" name="order_id" value="{order.order_id}">
	<tr>
	    ...
	    <td align="left" IF="order.status=config.General.clear_cc_info"><widget class="CStatusSelect" field="substatus" value="{order.orderStatus.status}" style="width: 150px; border-width: 1px; border-color: #516176; border-style: solid;"></td>
        <td align="left" IF="!order.status=config.General.clear_cc_info"><widget class="CStatusSelect" field="substatus" value="{order.orderStatus.status}" style="width: 150px; border-width: 1px; border-color: #516176; border-style: solid;" pm="{order.paymentMethod.payment_method}"></td>
        {else:}
        <td align="left"><widget class="CStatusSelect" field="substatus" value="{order.orderStatus.status}" style="width: 150px; border-wi
