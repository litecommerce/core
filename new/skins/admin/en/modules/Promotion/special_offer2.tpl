...
Add product: <widget class="CProductSelect" formName="offerForm" formField="addProduct" removeButton>
{end:}
...
<tr><td>Product:</td><td>{if:product&product.product_id&!product.exists}<span class="ErrorMessage">A deleted product (#{product.product_id}) has been found!</span>&nbsp;{end:}<widget class="CProductSelect" formName="offerForm" formField="product" removeButton></td></tr>
<tr><td>Category:</td><td>{if:category&category.category_id&!category.exists}<span class="ErrorMessage">A deleted category (#{category.category_id}) has been found!</span>&nbsp;{end:}<widget class="CCategorySelect" fieldName="category_id" noneOption></td></tr>
<tr>
	<td>Quantity:</td>
	<td>
		<input type="text" size="5" name="amount" value="{amount}"> 
        <widget class="CPatternValidator" template="modules/Promotion/amount_validator.tpl" field="amount" pattern="/^[1-9][0-9.]*$/">
	</td>
</tr>
</table>
{end:}
...
Minimum order subtotal: <input type="text" name="amount" value="{amount}" size="6"><widget class="CPatternValidator" template="modules/Promotion/amount_validator.tpl" field="amount" pattern="/^[1-9][0-9.]*$/"><br>
{end:}
...
<tr>
	...
	<td>
		<widget class="CPromotionMembershipValidator" field="customer_memberships"> 
	</td>
</tr>
</table>
{end:}
...
<widget class="CProductSelect" formName="offerForm" formField="addBonusProduct">
</span>
<span IF="bonusProducts">
<table border="0" cellpadding=0 cellspacing=0>
<tr><td class=CenterBorder>
...
Add product: <widget class="CProductSelect" formName="offerForm" formField="addBonusProduct">
</span>
<p>
<b>On the following category:</b>{if:bonusCategory&!bonusCategory.exists}&nbsp;<span class="ErrorMessage">A deleted category (#{bonusCategory.category_id}) has been found!</span>&nbsp;{end:} <widget class="CCategorySelect" fieldName="bonusCategory_id" noneOption>
{end:}
...
<tr class=Center>
	<td><widget class="CProductSelect" formName="offerForm" formField="addBonusPriceProduct"></td>
	<td><widget class="CCategorySelect" fieldName="addBonusPriceCategory_id" noneOption></td>
	<td>&nbsp;</td>
...
<table border="0" cellpadding=0 cellspacing=0>
	<tr>
		...
		<td>
			&nbsp;<widget class="CDate" field="start_date" value="{start_date}"> 
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			 &nbsp;<widget class="CDate" field="end_date" value="{end_date}">
		</td>
	</tr>
</table> 
<p align="center">
