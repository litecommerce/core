...
{end:}
<widget class="CPager" name="pager" data="{coupons}" itemsPerPage="{config.Promotion.coupons_per_page}">
...
<td colspan=7>
    ...
    <td class="TableHead">
        ...
        <td IF="child.order" width=90>&nbsp;<widget class="CStatusSelect" order="{child.order}" template="common/order_status.tpl"></td>
...
<tr><td>Expires</td>
<td>
<widget class="CDate" field="expire">
</td></tr>
<TR>
...
<tr><td valign="top"><INPUT type="radio" name="applyTo" value="product" checked="{applyTo=#product#}"></td><td>one product<br><widget class="CProductSelect" formName="coupon_form"></td></tr>
<tr><td valign="top"><INPUT type="radio" name="applyTo" value="category" checked="{applyTo=#category#}"></td><td>one category
<br><widget class="CCategorySelect" fieldName="category_id">
</td>
</tr>
</table>
</td></tr> </table>
