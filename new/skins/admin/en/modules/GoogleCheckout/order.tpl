...
<table border=0 cellpadding=3 cellspacing=2 width="100%">
	<tr>
		<td><widget template="modules/GoogleCheckout/separator.tpl" caption="Google Checkout order details"></td>
	</tr>
	<tr>
...
<table border=0 cellpadding=3 cellspacing=2 width="100%">
    <tr>
        <td><widget template="modules/GoogleCheckout/separator.tpl" caption="Charge order"></td>
    </tr>
	<tr>
...
<table border=0>
	<tr>
		...
		<td><widget class="CRequiredValidator" field="charge_amount"></td>
	</tr>
</table>
		</td>
	</tr>
...
{if:googleAllowRefund}
	<tr>
		<td><widget template="modules/GoogleCheckout/separator.tpl" caption="Refund order"></td>
	</tr>
	<tr>
		<td>
...
<table border=0>
	<tr>
		...
		<td><widget class="CRequiredValidator" field="refund_amount"></td>
	</tr>
	<tr>
		...
		<td><widget class="CRequiredValidator" field="refund_reason"></td>
	</tr>
	<tr>
		<td nowrap align=right><b>Comment:</b></td>
		<td>&nbsp;</td>
		<td><textarea name="refund_comment" rows=3 cols=70>{refund_comment:h}</textarea></td>
		<td><widget class="CRequiredValidator" field="refund_comment"></td>
	</tr>
	<tr>
...
{if:googleAllowCancel}
	<tr>
		<td><widget template="modules/GoogleCheckout/separator.tpl" caption="Cancel order"></td>
	</tr>
	<tr>
...
<table border=0>
	<tr>
		...
		<td><widget class="CRequiredValidator" field="cancel_reason"></td>
	</tr>
	<tr>
		<td nowrap align=right><b>Comment:</b></td>
		<td>&nbsp;</td>
		<td><textarea name="cancel_comment" rows=3 cols=70>{cancel_comment:h}</textarea></td>
		<td><widget class="CRequiredValidator" field="cancel_comment"></td>
	</tr>
	<tr>
...
<table border=0 cellpadding=3 cellspacing=2 width="100%">
	<tr>
		<td><widget template="modules/GoogleCheckout/separator.tpl" caption="Fulfillment commands"></td>
	</tr>
...
<table border=0 cellpadding=3 cellspacing=2 width="100%">
	<tr>
		<td><widget template="modules/GoogleCheckout/separator.tpl" caption="Send message"></td>
	</tr>
	<tr>
...
<table border=0>
	<tr>
		...
		<td><widget class="CRequiredValidator" field="message"></td>
	</tr>
</table>
		</td>
	</tr>
...
<table border=0 cellpadding=3 cellspacing=2 width="100%">
	<tr>
		<td><widget template="modules/GoogleCheckout/separator.tpl" caption="Archiving commands"></td>
	</tr>
	<tr>
