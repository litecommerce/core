<form action="admin.php#test_" method="GET">
	...
	<table border="0" cellpadding="3" cellspacing="0">
        ...
        <tr>
            <td>Country:</td> 
            <td IF="!destinationCountry=##"><widget class="CCountrySelect" field="destinationCountry" value="{destinationCountry}"></td>
            <td IF="destinationCountry=##"><widget class="CCountrySelect" field="destinationCountry" value="{config.General.default_country}"></td>
        </tr>
        <tr>
