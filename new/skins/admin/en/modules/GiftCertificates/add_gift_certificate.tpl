...
<tr><td colspan="3"><b><font class="ProductDetailsTitle">1. Who are you sending this to?<br>
</font></b>
...
<tr><td colspan="3">Enter the e-mail who you send a Gift Certificate to.<br><br></td></tr>
...
<td>&nbsp;</td>
<td>
<a href="javascript: document.gccreate.action.value='preview_ecard';document.gccreate.submit()"><img src="images/go.gif" width="13" height="13" border="0" align="absmiddle"> Preview e-Card</a>
    <br>&nbsp;
</td>
</tr>
</tbody>
...
<tr><td colspan=3><table border=0 cellspacing=0 cellpadding=0 width=100%><tr><td bgcolor=#CCCCCC><img src="{$ImagesDir}/null.gif" width=1 height=1 alt=""><br></td></tr></table></td></tr>

<tr><td colspan=3>&nbsp;</td></tr>

<tr><td colspan=3><table border=0 cellspacing=0 cellpadding=0><tr>
<td align=right><INPUT type=radio name="send_via" value="P" checked="{send_via=#P#}"></td>
<td><b>Send via Postal Mail</b></td>
</tr></table></td>
</tr>

<tr><td colspan=3>Enter the postal address who you're sending a Gift Certificate to.<br><br></td></tr>
...
{if:versionUpper2_1}
<td>
    <widget class="CCountrySelect" field="recipient_country" onChange="javascript: populateStates(this,'recipient_state');" fieldId="recipient_country_select">
</td>
<td>
...
<tr>
	...
	<td><font class="Star">*</font></td>
	<td><widget class="CDate" field="expiration_date" value="{expiration_date}"></td>
	<td>&nbsp;</td>
</tr>
