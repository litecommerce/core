...
<img src="images/modules/Promotion/bonus_list.gif" width=59 height=48 border=0 align=left vspace=5 hspace=5 alt="">
...
<tr FOREACH="bonus.allBonusProducts,product">
    ...
    <!-- Product thumbnail -->
        <widget visible="{product.hasThumbnail()}" template="common/product_thumbnail.tpl" href="cart.php?target=product&product_id={product.product_id}&substring={substring:u}" thumbnail="{product.thumbnail.url}" margin="0px 5px 0px 0px">
        <div><a href="cart.php?target=product&amp;product_id={product.product_id}&amp;substring={substring:u}" IF="product.hasThumbnail()">See&nbsp;details&nbsp;<img src="images/details.gif" width="13" height="13" border="0" align="middle" alt=""></a></div>
        <br><br>
    </td>
    <td valign="top">
    <!-- Product details -->
        ...
        <br>
        <hr>
        <FONT class="ProductPriceTitle">Price:</FONT> <s><FONT class="ProductPrice">{price_format(product.listPrice):h}</FONT></s> <FONT class="ProductPrice">{price_format(bonus.getBonusTaxedPrice(product)):h}</FONT><br><br>
...
<center>
<widget class="CButton" href="cart.php?target=checkout" label="Continue checkout.." font="FormButton">
</center>
