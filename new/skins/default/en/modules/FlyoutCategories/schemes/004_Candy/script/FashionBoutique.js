...
//*********************  FashionBoutique ********************
function change_color_FashionBoutique(id, type, prefix, selected)	{
...
function change_parents_color_FashionBoutique(cat_id, type)	{
	...
	for (var x = 0; x < parents[cat_id].length; x++)	{
		...
		if(current_id != cat_id)	{
			...
			change_color_FashionBoutique(current_id, type, prefix);
		}
	}
}
//**********************  End (FashionBoutique)  *******************
...
function CategoryBody_FashionBoutique(id, href, caption)
{
...
function SubCategoryBody_FashionBoutique(id, href, caption)
{
	obj = document.getElementById(id);
	if ( !obj ) return;
	line1_id = id + "_line1";
