...
<table border="0" cellpadding="0" cellspacing="10" width="600">
    ...
    <tr>
        <td>Category:</td>
		<td colspan="3"> <widget template="modules/AdvancedSearch/select_category.tpl" class="CCategorySelect" fieldName="search[category]" allOption search="{search}"><!--Should be: widgets/modules_AdvancedSearch_select_category.gif--></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
