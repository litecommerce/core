...
<tr>
	<td>
	<widget class="CButton" label="Reset" href="javascript: document.bulk_shopping_form.action.value=''; document.bulk_shopping_form.submit();">
	</td>	
	<td>
	<widget class="CButton" label="Calculate" href="javascript: document.bulk_shopping_form.action.value='calculate_price'; document.bulk_shopping_form.submit();">
	</td>
</tr>
<tr>
	<td colspan="2">
	<widget class="CButton" label="Add to Cart" href="javascript: document.bulk_shopping_form.submit()" img="cart4button.gif" font="FormButton">
	</td>
</tr>	
</table>
</form>
