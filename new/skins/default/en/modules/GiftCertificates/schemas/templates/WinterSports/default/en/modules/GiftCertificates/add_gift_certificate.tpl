...
{if:config.GiftCertificates.enablePostGC}
     ...
     if (document.gccreate.send_via[1].checked && (document.gccreate.recipient_firstname.value == "" || document.gccreate.recipient_lastname.value == "" || document.gccreate.recipient_address.value == "" || document.gccreate.recipient_city.value == "" || document.gccreate.recipient_zipcode.value == "" || document.gccreate.recipient_state.selectedIndex == 0))
     {
...
<td>&nbsp;<widget class="CRequiredValidator" field="purchaser"></td>
</tr>
...
<td>&nbsp;<widget class="CRequiredValidator" field="recipient"></td>
</tr>
...
<td>&nbsp;<widget class="CRangeValidator" field="amount" min="{config.GiftCertificates.minAmount}" max="{config.GiftCertificates.maxAmount}"></td>
</tr>
...
<tr IF="gc.ecard_id">
<td>
    <widget class="CButton" href="javascript: document.gccreate.action.value='delete_ecard';document.gccreate.submit()" label="Delete e-Card">
</td>
</tr>
<tr>
<td>
    <widget class="CButton" href="javascript: document.gccreate.action.value='select_ecard';document.gccreate.submit()" label="Select e-Card">
</td>
</tr>
</table>
</td>
...
<td>&nbsp;</td>
<td align="left">
<widget class="CButton" href="javascript: document.gccreate.action.value='preview_ecard';document.gccreate.submit()" label="Preview e-Card">
    <br>&nbsp;
</td>
</tr>
</tbody>
...
{if:versionUpper2_1}
    <td>
        <widget class="CStateSelect" field="recipient_state" onChange="javascript: changeState(this, 'recipient');" fieldId="recipient_state_select">
    </td>
    <td>
        <widget class="CStateValidator" field="recipient_state" countryField="recipient_country">
    </td>
{else:}
    <td>
        <widget class="CStateSelect" field="recipient_state" fieldId="recipient_state_select">
    </td>
{end:}
</tr>
...
{if:versionUpper2_1}
<td>
    <widget class="CCountrySelect" field="recipient_country" onChange="javascript: populateStates(this,'recipient');" fieldId="recipient_country_select">
</td>
<td>
    <widget class="CRequiredValidator" field="recipient_country">
</td>
{else:}
<td>
    <widget class="CCountrySelect" field="recipient_country"  fieldId="recipient_country_select">
</td>
{end:}
</tr>
...
<widget IF="isGCAdded()" class="CButton" href="javascript: formSubmit()" label="Update"/>
<widget IF="!isGCAdded()" class="CButton" href="javascript: formSubmit()" label="Add to cart"/>
</center>
