...
<tr>
	<td valign="top">
		...
		<table cellpadding="0" cellspacing="0" style="background-image:url('{xlite.layout.path}images/modules/LayoutOrganizer/film_tape/film_big.gif');background-repeat: no-repeat;">
		<tr>
			<td><img src="images/spacer.gif" width="25" height="159" alt=""></td>
			<td valign="top" width="100%"><img vspace="3" src="{product.imageURL}" border=0 alt=""></td>
		</tr>
		</table>
        ...
        <tr><td width="73%" class="ProductPriceTitle">Price:</td><td class="ProductPrice" nowrap>{price_format(product,#listPrice#):h}<font class="ProductPriceTitle"> {product.priceMessage:h}</font></td></tr>
   ...
   <td valign=top>
        ...
        <table id="productDetailsTable" cellpadding=0 cellspacing=0 border=0 width="100%">
		  <tr><td class="Line" height=1 colspan=2><img src="images/spacer.gif" width=1 height=1 border=0 alt=""></td></tr>
        <tr ><td class="ProductTitle" colspan=2>Description</td></tr>
		  <tr><td colspan=2>&nbsp;<br>&nbsp;</td></tr>
        <tr id="description"><td style="COLOR: #616161; FONT-SIZE: 12px; FONT-FAMILY: Arial;" colspan=2>{description:h}</td></tr>
        <tr><td colspan=2>&nbsp;<br>&nbsp;</td></tr>
