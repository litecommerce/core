...
REPLACE INTO xlite_profiles (profile_id, login, password, access_level, order_id, billing_title, billing_firstname, billing_lastname, billing_phone, billing_address, billing_city, billing_state, billing_country, billing_zipcode, shipping_title, shipping_firstname, shipping_lastname, shipping_phone, shipping_address, shipping_city, shipping_state, shipping_country, shipping_zipcode, first_login, last_login, status, cms_profile_id) VALUES (1,'rnd_tester@cdev.ru','fe01ce2a7fbac8fafaed7c982a04e229',100,0,'Mr.','Guest','Guest','0123456789','Billing street, 1','Edmond',38,'US','73003','Mr.','Guest','Guest','9876543210','Shipping street, 1','Edmond',38,'US','73003',1053689339,1058449247,'E',1);
INSERT INTO xlite_profiles (profile_id, login, password, access_level, order_id, billing_title, billing_firstname, billing_lastname, billing_phone, billing_address, billing_city, billing_state, billing_country, billing_zipcode, shipping_title, shipping_firstname, shipping_lastname, shipping_phone, shipping_address, shipping_city, shipping_state, shipping_country, shipping_zipcode, first_login, last_login, status, cms_profile_id) VALUES (2,'demo@litecommerce.com','fe01ce2a7fbac8fafaed7c982a04e229',100,0,'Mr.','Guest','Guest','0123456789','Billing street, 1','Edmond',38,'US','73003','Mr.','Guest','Guest','9876543210','Shipping street, 1','Edmond',38,'US','73003',1053689339,1063630489,'E',2);
...
INSERT INTO xlite_orders (profile_id, orig_profile_id, total, subtotal, shipping_cost, tax, tracking, date, status, payment_method, details, notes, order_id, shipping_id, detail_labels, taxes) VALUES (3,2,521.43,521.43,0.00,0.00,'',UNIX_TIMESTAMP(NOW()),'P','PhoneOrdering','O:8:\"stdClass\":0:{}','',1,2,'O:8:\"stdClass\":0:{}','a:1:{s:3:\"Tax\";d:0;}');
...
INSERT INTO xlite_orders (profile_id, orig_profile_id, total, subtotal, shipping_cost, tax, tracking, date, status, payment_method, details, notes, order_id, shipping_id, detail_labels, taxes) VALUES (4,2,320,320,0.00,0.00,'',UNIX_TIMESTAMP(NOW())+60,'P','PhoneOrdering','O:8:\"stdClass\":0:{}','',2,2,'O:8:\"stdClass\":0:{}','a:1:{s:3:\"Tax\";d:0;}');
INSERT INTO xlite_order_items (item_id, order_id, orderby, product_id, price, amount, options) VALUES ('174',2,4,174,320,1,'');

INSERT INTO xlite_orders (profile_id, orig_profile_id, total, subtotal, shipping_cost, tax, tracking, date, status, payment_method, details, notes, order_id, shipping_id, detail_labels, taxes) VALUES (5,2,320,320,0.00,0.00,'',UNIX_TIMESTAMP(NOW())+120,'P','PhoneOrdering','O:8:\"stdClass\":0:{}','',3,2,'O:8:\"stdClass\":0:{}','a:1:{s:3:\"Tax\";d:0;}');
INSERT INTO xlite_order_items (item_id, order_id, orderby, product_id, price, amount, options) VALUES ('174',3,4,174,320,1,'');

INSERT INTO xlite_orders (profile_id, orig_profile_id, total, subtotal, shipping_cost, tax, tracking, date, status, payment_method, details, notes, order_id, shipping_id, detail_labels, taxes) VALUES (6,2,320,320,0.00,0.00,'',UNIX_TIMESTAMP(NOW())+180,'P','PhoneOrdering','O:8:\"stdClass\":0:{}','',4,2,'O:8:\"stdClass\":0:{}','a:1:{s:3:\"Tax\";d:0;}');
INSERT INTO xlite_order_items (item_id, order_id, orderby, product_id, price, amount, options) VALUES ('174',4,4,174,320,1,'');

INSERT INTO xlite_orders (profile_id, orig_profile_id, total, subtotal, shipping_cost, tax, tracking, date, status, payment_method, details, notes, order_id, shipping_id, detail_labels, taxes) VALUES (7,2,320,320,0.00,0.00,'',UNIX_TIMESTAMP(NOW())+240,'P','PhoneOrdering','O:8:\"stdClass\":0:{}','',5,2,'O:8:\"stdClass\":0:{}','a:1:{s:3:\"Tax\";d:0;}');
INSERT INTO xlite_order_items (item_id, order_id, orderby, product_id, price, amount, options) VALUES ('174',5,4,174,320,1,'');

INSERT INTO xlite_orders (profile_id, orig_profile_id, total, subtotal, shipping_cost, tax, tracking, date, status, payment_method, details, notes, order_id, shipping_id, detail_labels, taxes) VALUES (8,2,320,320,0.00,0.00,'',UNIX_TIMESTAMP(NOW())+300,'P','PhoneOrdering','O:8:\"stdClass\":0:{}','',6,2,'O:8:\"stdClass\":0:{}','a:1:{s:3:\"Tax\";d:0;}');
