...
<span IF="extraParams=##"><input FOREACH="allParams,key,val" type="hidden" name="{key}" value="{val:r}"/></span>
<span IF="!extraParams=##"><input FOREACH="extraParams,key,val" type="hidden" name="{key}" value="{val:r}"/></span>
