...
<table border="0">
	...
	<tr>
		...
		<td>
			...
			<option FOREACH="xlite.factory.XLite_Model_ShippingZone.findAll(),zone" value="{zone.shipping_zone}" selected="{isSelected(zone,#shipping_zone#,shipping_zone_range)}">{zone.name}</option>
			</select>
		</td>
	</tr>
</table>
