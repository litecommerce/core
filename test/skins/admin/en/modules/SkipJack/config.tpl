...
<p>
<span class="SuccessMessage" IF="updated">SkipJack parameters were successfully changed. Please make sure that the SkipJack payment method is enabled on the <a href="admin.php?target=payment_methods"><u>Payment methods</u></a> page before you can start using it.</span>
