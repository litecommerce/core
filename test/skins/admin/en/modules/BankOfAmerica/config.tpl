...
<p>
<span class="SuccessMessage" IF="updated">Bank of America parameters were successfully changed. Please make sure that the Bank of America payment method is enabled on the <a href="admin.php?target=payment_methods"><u>Payment methods</u></a> page before you can start using it.</span>
...
<option value=1 selected="{IsSelected(pm.params.param02,#1#)}"> PRESENT</option>
<option value=2 selected="{IsSelected(pm.params.param02,#2#)}">UNREADABLE</option>
<option value=9 selected="{IsSelected(pm.params.param02,#9#)}">NOTPRESENT</option>
</select>
</td>
</tr>
<tr>
