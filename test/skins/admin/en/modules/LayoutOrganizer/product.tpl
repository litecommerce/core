                	...
                	<td>
                        <table border=0 cellpadding="1" cellspacing="2" class="TableHead">
                        	...
                        	<tr class="Center" height=20>
                            	...
                            	<td nowrap>
                        		<widget class="CFormField" template="modules/LayoutOrganizer/select_scheme.tpl" field="custom_template" inherit scheme_id="{productCustomTemplate}" schemes="{schemes}">
                            	</td>
                        	</tr>
                        </table>
                	</td>
