...
<tr class="{getProfileRow(#TableRow#)}" height="25">
    <td class="ProductDetailsTitle">Membership</td>
	    ...
	    <td><widget class="CMembershipSelect" field="cloned_profile[membership]" value="{cloneProfile.membership}"></td>
</tr>
</table>
...
<tr class="{getProfileRow(#TableRow#)}" height="25">
    ...
    <td><widget class="CStateSelect" field="cloned_profile[billing_state]" value="{cloneProfile.billing_state}"></td>
</tr>
<tr class="{getProfileRow(#TableRow#)}" height="25">
    ...
    <td><widget class="CCountrySelect" field="cloned_profile[billing_country]" value="{cloneProfile.billing_country}"></td>
</tr>
<tr class="{getProfileRow(#TableRow#)}" height="25">
...
<tr class="{getProfileRow(#TableRow#)}" height="25">
    ...
    <td><widget class="CStateSelect" field="cloned_profile[shipping_state]" value="{cloneProfile.shipping_state}"></td>
</tr>
<tr class="{getProfileRow(#TableRow#)}" height="25">
    <td class="ProductDetailsTitle">Country</td>
    <td IF="target=#order#">{if:profile.shippingCountry}{profile.shippingCountry.country:h}{else:}N/A{end:}</td>
    <td><widget class="CCountrySelect" field="cloned_profile[shipping_country]" value="{cloneProfile.shipping_country}"></td>
</tr>
<tr class="{getProfileRow(#TableRow#)}" height="25">
    <td class="ProductDetailsTitle">Zip/Postal code</td>
