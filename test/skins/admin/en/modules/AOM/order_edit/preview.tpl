		...
		<td width="33%">
			<table>
			    ...
			    <tr>
                    ...
                    <td IF="target=#create_order#"><widget class="CStatusSelect" field="substatus" value="{order.orderStatus.status}" style="width: 150px; border-width: 1px; border-color: #516176; border-style: solid;"></td>
			    </tr>
                <tr>
	...
	<tr>
		<td colspan="5">	
			<table width="100%" cellpadding="2" cellspacing="2">
				...
				<widget module="WholesaleTrading" clone="1" template="modules/AOM/invoice_wsale.tpl">
			    <tr>
			        <td colspan="4" align="right" class="ProductDetailsTitle">Subtotal:</td>
			        <td align="right">{price_format(cloneOrder,#subtotal#):h}</td>
			    </tr>
				<widget module="Promotion" clone="1" template="modules/AOM/invoice_promotion.tpl">   
			    <tr>
				...
				<widget module="Promotion" clone="1" template="modules/AOM/invoice_bonus_points.tpl">   
				<widget module="GiftCertificates" clone="1" template="modules/AOM/invoice_gc.tpl">
				</table>
			</td>
		</tr>
		<tr>
