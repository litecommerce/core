...
<p>
<span class="SuccessMessage" IF="dialog.updated">Protx VSP Direct parameters were successfully changed. Please make sure that the ProtxDirect payment method is enabled on the <a href="admin.php?target=payment_methods"><u>Payment methods</u></a> page before you can start using it.</span>
