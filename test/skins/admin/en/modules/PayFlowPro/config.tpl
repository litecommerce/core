...
<p>
<span class="SuccessMessage" IF="updated">Parameters were successfully changed. Please make sure that the PayFlow Pro payment method is enabled on the <a href="admin.php?target=payment_methods"><u>Payment methods</u></a> page before you can start using it.</span>
...
<td><input type=password name=params[param04] size=24 value="{pm.params.param04}"></td>
</tr>
<tr>
<td>Vendor:</td>
...
<tr>
<td>Partner:</td>
<td><input type=text name=params[param03] size=24 value="{pm.params.param03}"></td>
</tr>
<tr>
...
<option value="A" selected="{IsSelected(pm.params.param07,#A#)}">Auth</option>
<option value="S" selected="{IsSelected(pm.params.param07,#S#)}">Sale</option>
</select>
</td>
</tr>
<tr>
...
<option value="EUR" selected="{IsSelected(pm.params.currency,#EUR#)}">EUR</option>
<option value="GBP" selected="{IsSelected(pm.params.currency,#GBP#)}">GBP</option>
<option value="CAD" selected="{IsSelected(pm.params.currency,#CAD#)}">CAD</option>
<option value="JPY" selected="{IsSelected(pm.params.currency,#JPY#)}">JPY</option>
<option value="AUD" selected="{IsSelected(pm.params.currency,#AUD#)}">AUD</option>
</select>
</td>
</tr>
<tr>
