...
<tr>
    ...
    <td>&nbsp;</td>
	<td><widget class="CStatusSelect" field="params[status_chargeable]" value="{pm.chargeableStatus}"></td>
</tr>
<tr>
	<td nowrap align="right">'CHARGED' order status:</td>
    <td>&nbsp;</td>
	<td><widget class="CStatusSelect" field="params[status_charged]" value="{pm.chargedStatus}"></td>
</tr>
<tr>
	<td nowrap align="right">Declined/Canceled/Failed order status:</td>
    <td>&nbsp;</td>
	<td><widget class="CStatusSelect" field="params[status_failed]" value="{pm.failedStatus}"></td>
</tr>
