...
<p>
<span class="SuccessMessage" IF="dialog.updated">eWAYxml parameters were successfully changed. Please make sure that the eWAYxml payment method is enabled on the <a href="admin.php?target=payment_methods"><u>Payment methods</u></a> page before you can start using it.</span>
