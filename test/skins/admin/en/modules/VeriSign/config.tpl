...
<p>
<span class="SuccessMessage" IF="updated">Verisign parameters were successfully changed. Please make sure that the Verisign payment method is enabled on the <a href="admin.php?target=payment_methods"><u>Payment methods</u></a> page before you can start using it.</span>
...
<option value="A" selected="{IsSelected(pm.params.param07,#A#)}">Auth
<option value="S" selected="{IsSelected(pm.params.param07,#S#)}">Sale
</select>
</td>
</tr>
...
<tr>
<td>Gateway URL:</td>
<td><input type=text size=48 name=params[param05] value="{pm.params.param05}"></td>
</tr>
<td>Test gateway URL:</td>
<td><input type=text size=48 name=params[param06] value="{pm.params.param06}"></td>
</tr>
<tr>
<td colspan=2>
