<p><span IF="mode=#add#">Mandatory fields are marked with an asterisk (<font class="Star">*</font>).<br><br></span>
...
<table border="0" width="100%">
    ...
    <tr>
        ...
        <td class=Star>*</td>
        <td>{if:mode=#add#}<widget class="XLite_View_CategorySelect" fieldName="parent" selectedCategoryId="{category_id}" rootOption>{else:}<widget class="XLite_View_CategorySelect" selectedCategoryId="{parent}" fieldName="parent" rootOption currentCategoryId="{category_id}">{end:}
        </td>
    </tr>
	<tr>
...
<widget module="FlyoutCategories" template="modules/FlyoutCategories/add_modify_body.tpl">
    ...
    <tr>
        <td colspan=3>
           <input IF="mode=#add#" type="submit" value="Add"/>
           <input IF="mode=#modify#" type="submit" value="Update"/>
        </td>
    </tr>
</table>
</form>
