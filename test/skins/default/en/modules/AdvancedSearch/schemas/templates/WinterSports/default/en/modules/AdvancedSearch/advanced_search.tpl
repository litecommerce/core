...
<table border="0" cellpadding="0" cellspacing="10" width="600">
	<tr>
		...
		<td width="100px"> <widget class="XLite_View_Button" label="Search" href="javascript: document.adsearch_form.submit()" img="" font="FormButton"></td>
	</tr>	
    <tr>
        <td>Containing:</td>
...
<table border="0" cellpadding="0" cellspacing="10" width="600">
    ...
    <tr>
        <td>Category:</td>
		<td colspan="3"> <widget template="modules/AdvancedSearch/select_category.tpl" class="XLite_View_CategorySelect" fieldName="search[category]" allOption search="{search}"><!--Should be: widgets/modules_AdvancedSearch_select_category.gif--></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    ...
    <tr>
        <td>&nbsp;</td>
	    <td> <widget class="XLite_View_Button" label="Search" href="javascript: document.adsearch_form.submit()" img="" font="FormButton"></td>
		<td nowrap><a href="javascript: ClearAllFilters();" onClick="this.blur()"><img src="images/custom/go.gif" width="12" height="13" border="0" align="left" alt=""><b> Clear settings</b></a></td>
		<td nowrap colspan="2"><a if="{auth.logged}" href="javascript: SaveFilters();" onClick="this.blur()"><img src="images/custom/go.gif" width="12" height="13" border="0" align="left" alt=""><b> Save settings</b></a></td>
    </tr>
</table>
</form>
