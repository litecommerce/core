	...
	<tr valign="top">
		...
		<td width="33%">
			<table>
                ...
                <tr>
                    <td nowrap class="AomProductDetailsTitle">E-mail:</td>
                    <td>&nbsp;</td>
		...
		<td width="34%">
            <table>
                <tr>
                    <td nowrap class="AomProductDetailsTitle">Payment method:</td>
                    <td>&nbsp;</td> 
                    <td>{if:order.paymentMethod}{order.paymentMethod.name:h}{else:}N/A{end:}</td>
                </tr>
                <tr> 
                    <td nowrap class="AomProductDetailsTitle">Delivery:</td>
                    <td>&nbsp;</td> 
                    <td>{if:order.shipped}{if:order.shippingMethod}{order.shippingMethod.name:h}{else:}Free{end:}{else:}N/A{end:}</td>
                </tr>
            </table>
		</td>
	</tr>
	<tr>
		<td colspan="3"><widget template="common/hr.tpl"></td>
	</tr>
</table>
<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr valign="top">
		<td>
			<table>
				<tr IF="config.Company.company_name">
					<td class="AomProductDetailsTitle">Company:</td>
                	<td>{config.Company.company_name:h}</td>
				</tr>
                <tr>
                    <td class="AomProductDetailsTitle">Address:</td>
                    <td>{config.Company.location_address:h}, {config.Company.location_city:h}</td>
                </tr>
                <tr>
                    <td class="AomProductDetailsTitle">&nbsp;</td>
...
<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    <tr>
		<td>
			<table>
				<tr valign="top">
					<td nowrap class="AomProductDetailsTitle">Name:</td>
...
<widget template="modules/AOM/invoice_so.tpl">
<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="5"><br><br></td>
	</tr>	
    <tr>
        <td colspan="5" class="AomProductDetailsTitle" align="center">Products Ordered</td>
    </tr>
	<tr>
		<td colspan="5">	
			<table width="100%" cellpadding="2" cellspacing="2">
				...
				<tr FOREACH="order.items,item" valign="top">
				   	<td class="AomProductDetailsTitle"><span IF="item.product.product_id"><a href="{xlite.shopUrl(#cart.php#)}?target=product&product_id={item.product.product_id}">{truncate(item,#name#,#40#):h}</a></span><span IF="!item.product.product_id">{truncate(item,#name#,#40#):h}</span><br>	
						<table cellspacing="5">	
				...
				<tr IF="!order.items">
					<td colspan="5" class="AomProductDetailsTitle" align="center">No products</td>
				</tr>
				<tr>
					<td colspan="5" valign="top"><widget template="common/hr.tpl"></td>
				</tr>
				<widget module="WholesaleTrading" template="modules/AOM/invoice_wsale.tpl">
			    <tr>
			        <td colspan="4" align="right" class="AomProductDetailsTitle">Subtotal:</td>
			        <td align="right">{price_format(order,#subtotal#):h}</td>
			    </tr>
				<widget module="Promotion" template="modules/AOM/invoice_promotion.tpl">   
			    <tr>
			        <td colspan="4" align="right" class="AomProductDetailsTitle">Shipping cost:</td>
			        <td align="right">{price_format(order.shipping_cost):h}</td>
			    </tr>
				<tr FOREACH="order.getDisplayTaxes(),tax_name,tax">
			        <td colspan="4" align="right" class="AomProductDetailsTitle">{order.getTaxLabel(tax_name)}:</td>
			        <td align="right">{price_format(tax):h}</td>
			    </tr>
				<widget module="Promotion" template="modules/AOM/invoice_bonus_points.tpl">   
				<widget module="GiftCertificates" template="modules/AOM/invoice_gc.tpl">
				</table>
			</td>
		</tr>
		<tr>
		<td><widget template="common/hr.tpl">
		<table width="100%" cellpadding="3" cellspacing="0">
			<tr>	
		        <td class="AomTableHead" align="right"><b>Total:</b></td>
		        <td class="AomTableHead" width="100px" align="right"><b>{price_format(order,#total#):h}</b></td>
			</tr>
		</table>
		</td>
	</tr>
