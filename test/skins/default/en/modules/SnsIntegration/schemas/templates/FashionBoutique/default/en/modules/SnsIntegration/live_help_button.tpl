...
<tr>
    <td IF="!xlite.config.FashionBoutique.useLocalSnsImages" align="center">
    ...
    <td IF="xlite.config.FashionBoutique.useLocalSnsImages" align="center">
        ...
        <noscript>
            <a href="{snsTrackerURL}/leaveMessage.{config.SnsIntegration.collectorLanguage}?noscript=true" target="_blank">
                <img border="0" src="images/custom/modules/SnsIntegration/leave_message.jpg" style="cursor: pointer" alt="Powered by Sales-n-Stats">
            </a>
        </noscript>
    </td>
</tr>
<tr IF="!xlite.config.FashionBoutique.useLocalSnsImages">
