...
<tr valign="middle">
    ...
    <td colspan="2"><widget class="XLite_Validator_ArrayFieldValidator" field="ch_info[ch_routing_number]"></td>
</tr>
<tr valign="middle">
    ...
    <td colspan="2"><widget class="XLite_Validator_ArrayFieldValidator" field="ch_info[ch_acct_number]"></td>
</tr>
<tr valign="middle">
...
<tr valign="middle">
    ...
    <td colspan="2"><widget class="XLite_Validator_ArrayFieldValidator" field="ch_info[ch_bank_name]"></td>
</tr>
<tr valign="middle">
...
<tr IF="displayNumber">
    ...
    <td colspan="2"><widget class="XLite_Validator_ArrayFieldValidator" field="ch_info[ch_number]"></td>
</tr>
</table>
