...
<tr>
    ...
    <!-- Product thumbnail -->
        <a href="cart.php?target=product&amp;product_id={product.product_id}&amp;substring={substring:u}" IF="product.hasThumbnail()"><img src="{product.thumbnailURL}" border=0 width=70 alt=""></a> <br><a href="cart.php?target=product&amp;product_id={product.product_id}&amp;substring={substring:u}" IF="product.hasThumbnail()">See&nbsp;details&nbsp;<img src="images/details.gif" width="13" height="13" border="0" align="middle" alt=""></a>
        <br><br>
    </td>
    <td valign="top">
    <!-- Product details -->
