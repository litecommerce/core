...
<p><a href="{xlite.shopUrl(#cart.php#)}?target=news&action=confirm&type=subscribe&email={email}&code={code}">{xlite.shopUrl(#cart.php#)}?target=news&action=confirm&type=subscribe&email={email}&code={code}</a></p>
