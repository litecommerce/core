...
<tr IF="cart.empty">
    <td align="center" class="XLite_Model_Cart" ><img src="images/custom/cart.gif" alt=""> Cart is empty</td>
</tr>    
<tr IF="!cart.empty">
    <td>
        <table width="100%">
...
<tr>
	<td height="5"><img src="{$ImagesDir}/spacer.gif" width="1" height="5" alt=""></td>
</tr>
<tr>
	<td height="1" class="bg_menuhr"><img src="{$ImagesDir}/spacer.gif" width="1" height="1" alt=""></td>
</tr>
<tr>
	<td height="3"><img src="{$ImagesDir}/spacer.gif" width="1" height="3" alt=""></td>
</tr>
</table></td>
        </tr>
        <tr>
