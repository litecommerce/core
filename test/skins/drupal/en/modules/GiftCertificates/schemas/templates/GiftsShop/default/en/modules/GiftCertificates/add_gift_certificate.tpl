...
<widget IF="gc.gcid" class="XLite_View_Button" href="javascript: formSubmit()" label="Update"/>
<widget IF="!gc.gcid" class="XLite_View_Button" href="javascript: formSubmit()" label="Add to cart"/>
</center>
