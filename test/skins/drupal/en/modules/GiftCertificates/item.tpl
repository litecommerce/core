...
<tr>
    ...
    <td>
        ...
        <br>
        <br>
        <widget class="XLite_View_Button" href="cart.php?target=add_gift_certificate&gcid={item.gcid}" label="Modify certificate" font="FormButton">
        &nbsp;&nbsp;&nbsp;
        <widget class="XLite_View_Button" href="cart.php?target=cart&action=delete&cart_id={cart_id}" label="Delete item" font="FormButton">
    </td>
</tr>
</table>
