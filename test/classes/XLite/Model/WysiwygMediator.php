...
class XLite_Model_WysiwygMediator extends Widget // {{{
{
...
class XLite_Model_WysiwygMediator extends FlexyCompiler // {{{
{
...
class XLite_Model_WysiwygMediator extends XLite_Model_FlexyCompiler
{
    var $imagesDir = null;
    var $template = null;
