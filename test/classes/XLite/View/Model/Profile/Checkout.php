...
/**
 * Profile model widget (Checkout page)
 * 
 * @package XLite
 * @see     ____class_see____
 * @since   3.0.0
 */
class XLite_View_Model_Profile_Checkout extends XLite_View_Model_Profile_Abstract
{
    /**
    ...
    {
        return XLite_Model_Session::getInstance()->get('profile_id');
    }
}
