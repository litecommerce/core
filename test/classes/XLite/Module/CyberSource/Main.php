...
/**
* @package Module_CyberSource
* @access public
* @version $Id$
*/
class XLite_Module_CyberSource_Main extends XLite_Module_Abstract
{
    /**
     * Module version
     *
     ...
     * @since  3.0
     */
    protected $description = 'CyberSource credit card payment processor';
