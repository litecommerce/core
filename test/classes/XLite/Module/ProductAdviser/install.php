...
$check_str = "modules/ProductAdviser/menu.tpl";
$find_str = <<<EOT
<widget module="Promotion" template="modules/Promotion/menu.tpl">
EOT;
$replace_str = <<<EOT
<widget module="Promotion" template="modules/Promotion/menu.tpl">
<widget module="ProductAdviser" template="modules/ProductAdviser/menu.tpl">
EOT;
patch_template($location, $check_str, $find_str, $replace_str);

// checking for InventoryTracking module
$location = "skins/admin/en/modules/InventoryTracking/inventory_tracking.tpl";
if (is_template_patched($location, "inventory_tracking")) {
    // patching "skins/admin/en/modules/InventoryTracking/inventory_tracking.tpl"
    $check_str = "modules/ProductAdviser/inventory_changed.tpl";
    $find_str = <<<EOT
...
if (is_template_patched($location, "inventory_form")) {
    // patching "skins/admin/en/modules/ProductOptions/inventory_tracking.tpl"
    $check_str = "modules/ProductAdviser/inventory_changed.tpl";
    $find_str = <<<EOT
...
if (!is_template_patched($location, "modules/ProductAdviser/price_changed.tpl")) {
    $find_str = <<<EOT
</tr>
...
$check_str = "modules/ProductAdviser/price_list_changed.tpl";
...
EOT;
patch_template($location, "modules/ProductAdviser/product_list.tpl", $find_str, $replace_str);
...
// checking for InventoryTracking module
$location = "skins/default/en/modules/InventoryTracking/out_of_stock.tpl";
if (is_template_patched($location, "OutOfStock")) {
    // patching "skins/default/en/modules/InventoryTracking/out_of_stock.tpl"
    $check_str = "modules/ProductAdviser/OutOfStock/add_to_cart.tpl";
    $find_str = <<<EOT
...
// checking for InventoryTracking module
$location = "skins/default/en/modules/InventoryTracking/product_quantity.tpl";
if (is_template_patched($location, "product.inventory.amount")) {
    // patching "skins/default/en/modules/InventoryTracking/product_quantity.tpl"
    $check_str = "modules/ProductAdviser/OutOfStock/product_quantity.tpl";
    $find_str = <<<EOT
...
// checking for ShowcaseOrganizer module
$location = "skins/default/en/modules/ShowcaseOrganizer/icons.tpl";
if (is_template_patched($location, "ShowcaseOrganizer")) {
    // patching "skins/default/en/modules/ShowcaseOrganizer/icons.tpl"
    $check_str = "modules/ProductAdviser/PriceNotification/category_button.tpl";
    $find_str = <<<EOT
    	<span IF="product&config.ShowcaseOrganizer.so_show_price"><FONT class="ProductPriceTitle">Price: </FONT><FONT class="ProductPrice">{price_format(product,#listPrice#):h}</FONT><FONT class="ProductPriceTitle"> {product.priceMessage:h}</FONT><br></span>
EOT;
    $replace_str = <<<EOT
    	<span IF="product&config.ShowcaseOrganizer.so_show_price"><FONT class="ProductPriceTitle">Price: </FONT><FONT class="ProductPrice">{price_format(product,#listPrice#):h}</FONT><FONT class="ProductPriceTitle"> {product.priceMessage:h}</FONT><br><widget module="ProductAdviser" template="modules/ProductAdviser/PriceNotification/category_button.tpl" visible="{!priceNotificationSaved}" product="{product}" visible="{!getPriceNotificationSaved(product.product_id)}"><br></span>
EOT;
    patch_template($location, $check_str, $find_str, $replace_str);

    $check_str = "modules/ProductAdviser/PriceNotification/notify_form.tpl";
    $find_str = <<<EOT
<widget name="pager">
EOT;
    $replace_str = <<<EOT
...
// checking for ShowcaseOrganizer module
$location = "skins/default/en/modules/ShowcaseOrganizer/list.tpl";
if (is_template_patched($location, "ShowcaseOrganizer")) {
    // patching "skins/default/en/modules/ShowcaseOrganizer/list.tpl"
    $check_str = "modules/ProductAdviser/PriceNotification/category_button.tpl";
    $find_str = <<<EOT
				<!--AFTER PRICE-->
EOT;
...
// checking for ShowcaseOrganizer module
$location = "skins/default/en/modules/ShowcaseOrganizer/table.tpl";
if (is_template_patched($location, "ShowcaseOrganizer")) {
    // patching "s/default/en/modules/ShowcaseOrganizer/table.tpl"
    $check_str = "modules/ProductAdviser/PriceNotification/category_button.tpl";
    $find_str = <<<EOT
	<td nowrap IF="config.ShowcaseOrganizer.so_show_price"><FONT class="ProductPrice">{price_format(product,#listPrice#):h}</FONT><FONT class="ProductPriceTitle"> {product.priceMessage:h}</FONT></td>
EOT;
    $replace_str = <<<EOT
	<td nowrap IF="config.ShowcaseOrganizer.so_show_price"><FONT class="ProductPrice">{price_format(product,#listPrice#):h}</FONT><FONT class="ProductPriceTitle"> {product.priceMessage:h}</FONT><widget module="ProductAdviser" template="modules/ProductAdviser/PriceNotification/category_button.tpl" visible="{!priceNotificationSaved}" product="{product}" visible="{!getPriceNotificationSaved(product.product_id)}"></td>
EOT;
    patch_template($location, $check_str, $find_str, $replace_str);
...
EOT;
    $replace_str = <<<EOT
<widget module="ProductAdviser" template="modules/ProductAdviser/PriceNotification/category_button.tpl" visible="{!priceNotificationSaved}" product="{featuredProduct.product}" visible="{!getPriceNotificationSaved(featuredProduct.product.product_id)}">
<!--AFTER PRICE-->
EOT;
    patch_template($location, $check_str, $find_str, $replace_str);
...
if (!is_template_patched($location, "modules/ProductAdviser/PriceNotification/product_button.tpl")) {
    $find_str = <<<EOT
...
$check_str = "modules/ProductAdviser/OutOfStock/notify_form.tpl";
$find_str = <<<EOT
</form>
EOT;
$replace_str = <<<EOT
...
$check_str = "modules/ProductAdviser/OutOfStock/cart_item.tpl";
$find_str = <<<EOT
