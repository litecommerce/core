...
{ // {{{	 
	...
	function getWishlist() // {{{
	{
		if (is_null($this->wishlist)) {
			$this->wishlist = new XLite_Module_WishList_Model_WishList($this->wishlist_id);
		}
	...
	{
		$wishlist = new XLite_Module_WishList_Model_WishList($this->wishlist_id);
		$wishlist_products = $wishlist->get("products");
		foreach($wishlist_products as $product)
			$product->delete();
		$wishlist->delete();
		$this->set("returnUrl","admin.php?target=wishlists");
	}
	// }}}
