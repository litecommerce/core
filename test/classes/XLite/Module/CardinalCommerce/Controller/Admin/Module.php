...
/**
* Admin_Dialog_module_CardinalCommerce description.
*
* @package Module_CardinalCommerce
* @access public
* @version $Id$
*/
class XLite_Module_CardinalCommerce_Controller_Admin_Module extends XLite_Controller_Admin_Module implements XLite_Base_IDecorator
{
	function init()
	{
		parent::init();
