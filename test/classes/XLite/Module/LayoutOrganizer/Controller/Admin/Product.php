...
* @version $Id$
*/
class XLite_Module_LayoutOrganizer_Controller_Admin_Product extends XLite_Controller_Admin_Product implements XLite_Base_IDecorator
{
    function init()
    {
    ...
    function action_modify_templates()
    {
        if (isset($this->product_id) && $this->product_id > 0) {
    		...
    		if ($this->custom_template < 0) {
    			...
    			$scheme = new XLite_Module_LayoutOrganizer_Model_TemplatesScheme($this->custom_template);
    			if (is_object($scheme)) {
